...
public class GrammarVisitor {
    ...
    private Map<QualName,nl.utwente.groove.grammar.model.TypeModel> m_typeMap;
    private Map<QualName,HostModel> m_hostMap;
    private Map<QualName,RuleModel> m_ruleMap;
    private Map<QualName,nl.utwente.groove.grammar.model.TypeModel> m_metaMap;
    ...
    private void setRuleGraphs(Collection<nl.utwente.groove.grammar.model.RuleModel> ruleModels) {
