...
/**
 * The exporters that work by rendering a {@link CanvasExportable}.
 ...
 */
@NonNullByDefault
public class CanvasExporters {
    private CanvasExporters() {
        // empty, to prevent instantiation
    }

    /** Adds the canvas-based exporters to the {@link Exporters} registry.
