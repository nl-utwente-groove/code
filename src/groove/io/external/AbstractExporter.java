...
public abstract class AbstractExporter implements Exporter {
    ...
    @Override
    public final Kind getFormatKind() {
        return this.formatKind;
    }

    private final Kind formatKind;
