...
// GraphGrammar benchmarkRules = new AspectualViewGps().unmarshal(new
// File("sts.gps")).toGrammar();
// DefaultGraphCalculator calculator = new
// DefaultGraphCalculator(benchmarkRules);
