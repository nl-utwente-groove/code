...
/*
 * $Id: IntSet.java,v 1.1.1.1 2007-03-20 10:05:18 kastenberg Exp $
 */
package groove.util;
...
public interface IntSet {
	/**
	 * Clears the set.
	 * The maximum required capacity can be set.
	 * Afterwards {@link #size()} returns <code>0</code>.
	 ...
	 * @return <code>true</code> if the certificate was not in the store before
	 */
	boolean add(int key);
