...
/** 
 * Compares two objects based on their appearance in a given list.
 * All other objects are compared according to their natural ordering,
 * coming after the list elements.
 */
public class ListComparator<T extends Comparable<T>> implements Comparator<T> {
	/** 
	 * Constructs a comparator based on a given list of keys.
	 * These keys are ordered first, in the order given; other 
	...
	/** 
	 * First compares the objects as to their position in the known objects, then 
