...
/**
 * Tests for {@link MyHashSet} and {@link MyHashSetExtended}. These tests are
 * interesting if the store capacity of {@link MyHashSet} is small (5).
 * @author Iovka Boneva
 * @version $Revision $
 */
@Deprecated
public class TestingMyHashSet extends TestCase {
    ...
    /**
     * Two strings are equal if they are equal independently on the case. The
     * hash code is computed from the lower-case of the first and last
     * characters.
     */
    ...
    /**
     * Two strings are equal if they have same first and last character,
    ...
    class StringEqualizer implements Equalizer<String> {
        ...
        public boolean areEqual(String o1, String o2) {
            ...
            return l1.charAt(0) == l2.charAt(0)
                && l1.charAt(l1.length() - 1) == l2.charAt(l2.length() - 1);
        }
    }
    ...
    public void testHashSetExtended() throws AssertionError {
        // fill in a hash set
        MyHashSetExtended<String> set =
            new MyHashSetExtended<String>(new StringHasher());
        String s;
    ...
    public void testHashSetConflicting() throws AssertionError {
        MyHashSet<String> set =
            new MyHashSet<String>(new StringConflictHasher());
