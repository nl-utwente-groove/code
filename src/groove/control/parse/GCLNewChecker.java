// $ANTLR 3.2 Sep 23, 2009 12:02:23 GCLNewChecker.g 2010-11-23 23:22:44
...
public class GCLNewChecker extends TreeParser {
    ...
    public final GCLNewChecker.function_return function() throws RecognitionException {
        ...
        try {
            ...
            MyTree _first_1 = null;
            _last = (MyTree)input.LT(1);
            FUNCTION6=(MyTree)match(input,FUNCTION,FOLLOW_FUNCTION_in_function93); 


            if ( _first_0==null ) _first_0 = FUNCTION6;
            match(input, Token.DOWN, null); 
            _last = (MyTree)input.LT(1);
            ID7=(MyTree)match(input,ID,FOLLOW_ID_in_function95); 
    ...
    // $ANTLR start "block"
    // GCLNewChecker.g:65:1: block returns [ CtrlAut aut ] : ^( BLOCK ( stat )* ) ;
    public final GCLNewChecker.block_return block() throws RecognitionException {
        ...
        try {
            // GCLNewChecker.g:66:3: ( ^( BLOCK ( stat )* ) )
            // GCLNewChecker.g:66:5: ^( BLOCK ( stat )* )
            {
            _last = (MyTree)input.LT(1);
            {
            MyTree _save_last_1 = _last;
            MyTree _first_1 = null;
            _last = (MyTree)input.LT(1);
            BLOCK9=(MyTree)match(input,BLOCK,FOLLOW_BLOCK_in_block152); 
            ...
            if ( input.LA(1)==Token.DOWN ) {
                ...
                do {
                	...
                	case 1 :
                	    ...
                	    {
                	    _last = (MyTree)input.LT(1);
                	    pushFollow(FOLLOW_stat_in_block170);
                	    stat10=stat();
    ...
    // $ANTLR start "stat"
    // GCLNewChecker.g:73:1: stat : ( block | var_decl | ^( ALAP stat ) | ^( WHILE stat stat ) | ^( UNTIL stat stat ) | ^( TRY stat ( stat )? ) | ^( IF stat stat ( stat )? ) | ^( CHOICE stat ( stat )* ) | ^( STAR stat ) | rule | ANY | OTHER | TRUE );
    public final GCLNewChecker.stat_return stat() throws RecognitionException {
        ...
        try {
            // GCLNewChecker.g:74:3: ( block | var_decl | ^( ALAP stat ) | ^( WHILE stat stat ) | ^( UNTIL stat stat ) | ^( TRY stat ( stat )? ) | ^( IF stat stat ( stat )? ) | ^( CHOICE stat ( stat )* ) | ^( STAR stat ) | rule | ANY | OTHER | TRUE )
            int alt6=13;
            switch ( input.LA(1) ) {
            case BLOCK:
                {
            ...
            switch (alt6) {
                case 1 :
                    // GCLNewChecker.g:74:5: block
                    {
                    _last = (MyTree)input.LT(1);
                    pushFollow(FOLLOW_block_in_stat200);
                    block11=block();
                    ...
                    break;
                case 2 :
                    // GCLNewChecker.g:75:5: var_decl
                    {
                    _last = (MyTree)input.LT(1);
                    pushFollow(FOLLOW_var_decl_in_stat206);
                    var_decl12=var_decl();
                    ...
                    break;
                case 3 :
                    // GCLNewChecker.g:76:5: ^( ALAP stat )
                    {
                    _last = (MyTree)input.LT(1);
                    {
                    MyTree _save_last_1 = _last;
                    MyTree _first_1 = null;
                    _last = (MyTree)input.LT(1);
                    ALAP13=(MyTree)match(input,ALAP,FOLLOW_ALAP_in_stat213); 
                    ...
                    break;
                case 4 :
                    // GCLNewChecker.g:77:5: ^( WHILE stat stat )
                    {
                    _last = (MyTree)input.LT(1);
                    {
                    MyTree _save_last_1 = _last;
                    MyTree _first_1 = null;
                    _last = (MyTree)input.LT(1);
                    WHILE15=(MyTree)match(input,WHILE,FOLLOW_WHILE_in_stat224); 
                    ...
                    break;
                case 5 :
                    // GCLNewChecker.g:83:5: ^( UNTIL stat stat )
                    {
                    _last = (MyTree)input.LT(1);
                    {
                    MyTree _save_last_1 = _last;
                    MyTree _first_1 = null;
                    _last = (MyTree)input.LT(1);
                    UNTIL18=(MyTree)match(input,UNTIL,FOLLOW_UNTIL_in_stat275); 
                    ...
                    break;
                case 6 :
                    // GCLNewChecker.g:89:5: ^( TRY stat ( stat )? )
                    {
                    _last = (MyTree)input.LT(1);
                    {
                    MyTree _save_last_1 = _last;
                    MyTree _first_1 = null;
                    _last = (MyTree)input.LT(1);
                    TRY21=(MyTree)match(input,TRY,FOLLOW_TRY_in_stat326); 
                    ...
                    break;
                case 7 :
                    // GCLNewChecker.g:97:5: ^( IF stat stat ( stat )? )
                    {
                    _last = (MyTree)input.LT(1);
                    {
                    MyTree _save_last_1 = _last;
                    MyTree _first_1 = null;
                    _last = (MyTree)input.LT(1);
                    IF24=(MyTree)match(input,IF,FOLLOW_IF_in_stat400); 


                    if ( _first_0==null ) _first_0 = IF24;
                    match(input, Token.DOWN, null); 
                    _last = (MyTree)input.LT(1);
                    pushFollow(FOLLOW_stat_in_stat410);
                    stat25=stat();
                    ...
                    if ( _first_1==null ) _first_1 = stat25.tree;
                     helper.startBranch(); 
                    _last = (MyTree)input.LT(1);
                    pushFollow(FOLLOW_stat_in_stat429);
                    stat26=stat();
                    ...
                    switch (alt4) {
                        case 1 :
                            // GCLNewChecker.g:101:10: stat
                            {
                             helper.nextBranch(); 
                            _last = (MyTree)input.LT(1);
                            pushFollow(FOLLOW_stat_in_stat452);
                            stat27=stat();
                    ...
                    break;
                case 8 :
                    // GCLNewChecker.g:106:5: ^( CHOICE stat ( stat )* )
                    {
                    _last = (MyTree)input.LT(1);
                    {
                    MyTree _save_last_1 = _last;
                    MyTree _first_1 = null;
                    _last = (MyTree)input.LT(1);
                    CHOICE28=(MyTree)match(input,CHOICE,FOLLOW_CHOICE_in_stat486); 
                    ...
                    do {
                        ...
                        switch (alt5) {
                    	case 1 :
                    	    // GCLNewChecker.g:109:10: stat
                    	    {
                    	     helper.nextBranch(); 
                    	    _last = (MyTree)input.LT(1);
                    	    pushFollow(FOLLOW_stat_in_stat527);
                    	    stat30=stat();
                    ...
                    break;
                case 9 :
                    // GCLNewChecker.g:114:5: ^( STAR stat )
                    {
                    _last = (MyTree)input.LT(1);
                    {
                    MyTree _save_last_1 = _last;
                    MyTree _first_1 = null;
                    _last = (MyTree)input.LT(1);
                    STAR31=(MyTree)match(input,STAR,FOLLOW_STAR_in_stat563); 
                    ...
                    match(input, Token.DOWN, null); 
                    _last = (MyTree)input.LT(1);
                    pushFollow(FOLLOW_stat_in_stat581);
                    stat32=stat();
                    ...
                    break;
                case 10 :
                    // GCLNewChecker.g:119:5: rule
                    {
                    _last = (MyTree)input.LT(1);
                    pushFollow(FOLLOW_rule_in_stat603);
                    rule33=rule();
                    ...
                    break;
                case 11 :
                    // GCLNewChecker.g:120:5: ANY
                    {
                    _last = (MyTree)input.LT(1);
                    ANY34=(MyTree)match(input,ANY,FOLLOW_ANY_in_stat609); 
                    ...
                    break;
                case 12 :
                    // GCLNewChecker.g:122:5: OTHER
                    {
                    _last = (MyTree)input.LT(1);
                    OTHER35=(MyTree)match(input,OTHER,FOLLOW_OTHER_in_stat621); 
                    ...
                    break;
                case 13 :
                    // GCLNewChecker.g:124:5: TRUE
                    {
                    _last = (MyTree)input.LT(1);
                    TRUE36=(MyTree)match(input,TRUE,FOLLOW_TRUE_in_stat633); 
    ...
    // $ANTLR start "rule"
    // GCLNewChecker.g:127:1: rule : ^( CALL ID ( ^( ARGS ( arg )* ) )? ) ;
    public final GCLNewChecker.rule_return rule() throws RecognitionException {
        ...
        try {
            // GCLNewChecker.g:129:3: ( ^( CALL ID ( ^( ARGS ( arg )* ) )? ) )
            // GCLNewChecker.g:129:5: ^( CALL ID ( ^( ARGS ( arg )* ) )? )
            {
            _last = (MyTree)input.LT(1);
            {
            MyTree _save_last_1 = _last;
            MyTree _first_1 = null;
            _last = (MyTree)input.LT(1);
            CALL37=(MyTree)match(input,CALL,FOLLOW_CALL_in_rule651); 


            if ( _first_0==null ) _first_0 = CALL37;
            match(input, Token.DOWN, null); 
            _last = (MyTree)input.LT(1);
            ID38=(MyTree)match(input,ID,FOLLOW_ID_in_rule653); 
             
            if ( _first_1==null ) _first_1 = ID38;
            // GCLNewChecker.g:129:15: ( ^( ARGS ( arg )* ) )?
            int alt8=2;
            ...
            switch (alt8) {
                case 1 :
                    // GCLNewChecker.g:129:16: ^( ARGS ( arg )* )
                    {
                    _last = (MyTree)input.LT(1);
                    {
                    ...
                    _last = (MyTree)input.LT(1);
                    ARGS39=(MyTree)match(input,ARGS,FOLLOW_ARGS_in_rule657); 


                    if ( _first_1==null ) _first_1 = ARGS39;
                    if ( input.LA(1)==Token.DOWN ) {
                        match(input, Token.DOWN, null); 
                        // GCLNewChecker.g:129:23: ( arg )*
                        loop7:
                        do {
                            int alt7=2;
                        	...
                        	case 1 :
                        	    ...
                        	    {
                        	    _last = (MyTree)input.LT(1);
                        	    pushFollow(FOLLOW_arg_in_rule659);
                        	    arg40=arg();
    ...
    // GCLNewChecker.g:132:1: var_decl : ^( VAR type ( ID )+ ) ;
    public final GCLNewChecker.var_decl_return var_decl() throws RecognitionException {
        ...
        try {
            // GCLNewChecker.g:133:2: ( ^( VAR type ( ID )+ ) )
            // GCLNewChecker.g:133:4: ^( VAR type ( ID )+ )
            {
            _last = (MyTree)input.LT(1);
            {
            MyTree _save_last_1 = _last;
            MyTree _first_1 = null;
            _last = (MyTree)input.LT(1);
            VAR41=(MyTree)match(input,VAR,FOLLOW_VAR_in_var_decl678); 


            if ( _first_0==null ) _first_0 = VAR41;
            match(input, Token.DOWN, null); 
            _last = (MyTree)input.LT(1);
            pushFollow(FOLLOW_type_in_var_decl680);
            type42=type();
            ...
            do {
                ...
                switch (alt9) {
            	case 1 :
            	    // GCLNewChecker.g:135:9: ID
            	    {
            	    _last = (MyTree)input.LT(1);
            	    ID43=(MyTree)match(input,ID,FOLLOW_ID_in_var_decl697); 
    ...
    // $ANTLR start "type"
    // GCLNewChecker.g:141:1: type : ( NODE | BOOL | STRING | INT | REAL );
    public final GCLNewChecker.type_return type() throws RecognitionException {
        ...
        try {
            // GCLNewChecker.g:142:3: ( NODE | BOOL | STRING | INT | REAL )
            int alt10=5;
            switch ( input.LA(1) ) {
            case NODE:
                {
            ...
            switch (alt10) {
                case 1 :
                    // GCLNewChecker.g:142:5: NODE
                    {
                    _last = (MyTree)input.LT(1);
                    NODE44=(MyTree)match(input,NODE,FOLLOW_NODE_in_type736); 
                    ...
                    break;
                case 2 :
                    // GCLNewChecker.g:143:5: BOOL
                    {
                    _last = (MyTree)input.LT(1);
                    BOOL45=(MyTree)match(input,BOOL,FOLLOW_BOOL_in_type746); 
                    ...
                    break;
                case 3 :
                    // GCLNewChecker.g:144:5: STRING
                    {
                    _last = (MyTree)input.LT(1);
                    STRING46=(MyTree)match(input,STRING,FOLLOW_STRING_in_type756); 
                    ...
                    break;
                case 4 :
                    // GCLNewChecker.g:145:5: INT
                    {
                    _last = (MyTree)input.LT(1);
                    INT47=(MyTree)match(input,INT,FOLLOW_INT_in_type764); 
                    ...
                    break;
                case 5 :
                    // GCLNewChecker.g:146:5: REAL
                    {
                    _last = (MyTree)input.LT(1);
                    REAL48=(MyTree)match(input,REAL,FOLLOW_REAL_in_type775); 
    ...
    // $ANTLR start "arg"
    // GCLNewChecker.g:149:1: arg : ^( ARG ( ( OUT )? ID | DONT_CARE | literal ) ) ;
    public final GCLNewChecker.arg_return arg() throws RecognitionException {
        ...
        try {
            // GCLNewChecker.g:150:2: ( ^( ARG ( ( OUT )? ID | DONT_CARE | literal ) ) )
            // GCLNewChecker.g:150:4: ^( ARG ( ( OUT )? ID | DONT_CARE | literal ) )
            {
            _last = (MyTree)input.LT(1);
            {
            MyTree _save_last_1 = _last;
            MyTree _first_1 = null;
            _last = (MyTree)input.LT(1);
            ARG49=(MyTree)match(input,ARG,FOLLOW_ARG_in_arg795); 


            if ( _first_0==null ) _first_0 = ARG49;
            match(input, Token.DOWN, null); 
            // GCLNewChecker.g:151:7: ( ( OUT )? ID | DONT_CARE | literal )
            int alt12=3;
            switch ( input.LA(1) ) {
            case ID:
            case OUT:
            ...
            switch (alt12) {
                case 1 :
                    // GCLNewChecker.g:151:9: ( OUT )? ID
                    {
                    // GCLNewChecker.g:151:9: ( OUT )?
                    int alt11=2;
                    ...
                    switch (alt11) {
                        case 1 :
                            ...
                            {
                            _last = (MyTree)input.LT(1);
                            OUT50=(MyTree)match(input,OUT,FOLLOW_OUT_in_arg806); 
                    ...
                    _last = (MyTree)input.LT(1);
                    ID51=(MyTree)match(input,ID,FOLLOW_ID_in_arg809); 
                    ...
                    break;
                case 2 :
                    // GCLNewChecker.g:152:9: DONT_CARE
                    {
                    _last = (MyTree)input.LT(1);
                    DONT_CARE52=(MyTree)match(input,DONT_CARE,FOLLOW_DONT_CARE_in_arg821); 
                    ...
                    break;
                case 3 :
                    // GCLNewChecker.g:153:9: literal
                    {
                    _last = (MyTree)input.LT(1);
                    pushFollow(FOLLOW_literal_in_arg833);
                    literal53=literal();
    ...
    // $ANTLR start "literal"
    // GCLNewChecker.g:158:1: literal : ( TRUE | FALSE | STRING_LIT | INT_LIT | REAL_LIT );
    public final GCLNewChecker.literal_return literal() throws RecognitionException {
        ...
        try {
            // GCLNewChecker.g:159:3: ( TRUE | FALSE | STRING_LIT | INT_LIT | REAL_LIT )
            // GCLNewChecker.g:
            {
            _last = (MyTree)input.LT(1);
    ...
    public static final BitSet FOLLOW_FUNCTION_in_function93 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_ID_in_function95 = new BitSet(new long[]{0x0000000000000020L});
    public static final BitSet FOLLOW_block_in_function114 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_BLOCK_in_block152 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_stat_in_block170 = new BitSet(new long[]{0x0000000D46B80928L});
    public static final BitSet FOLLOW_block_in_stat200 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_var_decl_in_stat206 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ALAP_in_stat213 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_stat_in_stat215 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_WHILE_in_stat224 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_stat_in_stat233 = new BitSet(new long[]{0x0000000D46B80928L});
    public static final BitSet FOLLOW_stat_in_stat251 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_UNTIL_in_stat275 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_stat_in_stat284 = new BitSet(new long[]{0x0000000D46B80928L});
    public static final BitSet FOLLOW_stat_in_stat302 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_TRY_in_stat326 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_stat_in_stat344 = new BitSet(new long[]{0x0000000D46B80928L});
    ...
    public static final BitSet FOLLOW_stat_in_stat410 = new BitSet(new long[]{0x0000000D46B80928L});
    public static final BitSet FOLLOW_stat_in_stat429 = new BitSet(new long[]{0x0000000D46B80928L});
    public static final BitSet FOLLOW_stat_in_stat452 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_CHOICE_in_stat486 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_stat_in_stat504 = new BitSet(new long[]{0x0000000D46B80928L});
    public static final BitSet FOLLOW_stat_in_stat527 = new BitSet(new long[]{0x0000000D46B80928L});
    public static final BitSet FOLLOW_STAR_in_stat563 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_stat_in_stat581 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_rule_in_stat603 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ANY_in_stat609 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_OTHER_in_stat621 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_TRUE_in_stat633 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_CALL_in_rule651 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_ID_in_rule653 = new BitSet(new long[]{0x0000000000002008L});
    public static final BitSet FOLLOW_ARGS_in_rule657 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_arg_in_rule659 = new BitSet(new long[]{0x0000000000001008L});
    public static final BitSet FOLLOW_VAR_in_var_decl678 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_type_in_var_decl680 = new BitSet(new long[]{0x0000000000010000L});
    public static final BitSet FOLLOW_ID_in_var_decl697 = new BitSet(new long[]{0x0000000000010008L});
    public static final BitSet FOLLOW_NODE_in_type736 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_BOOL_in_type746 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_STRING_in_type756 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_INT_in_type764 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_REAL_in_type775 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ARG_in_arg795 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_OUT_in_arg806 = new BitSet(new long[]{0x0000000000010000L});
    public static final BitSet FOLLOW_ID_in_arg809 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_DONT_CARE_in_arg821 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_literal_in_arg833 = new BitSet(new long[]{0x0000000000000008L});
