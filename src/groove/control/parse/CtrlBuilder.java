...
public TreeAdaptor getTreeAdaptor() {
    ...
    public static final BitSet FOLLOW_functions_in_program65 = new BitSet(new long[]{0x0400000000000000L});
    ...
    public static final BitSet FOLLOW_ID_in_package_decl92 = new BitSet(new long[]{0x1000000000000000L});
    ...
    public static final BitSet FOLLOW_ID_in_import_decl132 = new BitSet(new long[]{0x1000000000000000L});
    ...
    public static final BitSet FOLLOW_ID_in_function169 = new BitSet(new long[]{0x0001000000000000L});
    ...
    public static final BitSet FOLLOW_recipe_in_recipes200 = new BitSet(new long[]{0x0200000000000008L});
    public static final BitSet FOLLOW_RECIPE_in_recipe216 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_ID_in_recipe218 = new BitSet(new long[]{0x0001000000000000L});
    ...
    public static final BitSet FOLLOW_par_decl_in_par_list265 = new BitSet(new long[]{0x0000800000000008L});
    public static final BitSet FOLLOW_PAR_in_par_decl282 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_OUT_in_par_decl284 = new BitSet(new long[]{0x0080010100002000L,0x0000000000000001L});
    ...
    public static final BitSet FOLLOW_stat_in_block329 = new BitSet(new long[]{0x9000100020019458L,0x000000000000007CL});
    ...
    public static final BitSet FOLLOW_stat_in_stat457 = new BitSet(new long[]{0x9000100020019450L,0x000000000000007CL});
    ...
    public static final BitSet FOLLOW_stat_in_stat479 = new BitSet(new long[]{0x9000100020019450L,0x000000000000007CL});
    ...
    public static final BitSet FOLLOW_stat_in_stat501 = new BitSet(new long[]{0x9000100020019458L,0x000000000000007CL});
    ...
    public static final BitSet FOLLOW_stat_in_stat526 = new BitSet(new long[]{0x9000100020019450L,0x000000000000007CL});
    public static final BitSet FOLLOW_stat_in_stat530 = new BitSet(new long[]{0x9000100020019458L,0x000000000000007CL});
    ...
    public static final BitSet FOLLOW_stat_in_stat564 = new BitSet(new long[]{0x9000100020019458L,0x000000000000007CL});
    public static final BitSet FOLLOW_stat_in_stat586 = new BitSet(new long[]{0x9000100020019458L,0x000000000000007CL});
    ...
    public static final BitSet FOLLOW_arg_in_rule702 = new BitSet(new long[]{0x0800000000000080L});
