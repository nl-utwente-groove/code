 ...
 */
public class OldPreviewControlAction extends SimulatorAction {
    /** Constructs a new action, for a given control panel. */
    public OldPreviewControlAction(Simulator simulator) {
    ...
    private OldCtrlJGraph getJGraph() throws FormatException {
        if (this.jGraph == null) {
            this.jGraph = new OldCtrlJGraph(getSimulator());
    ...
    private CtrlAut getCtrlAut() throws FormatException {
        ...
        if (grammarModel != null) {
            ...
            OldControlModel controlModel =
                    (OldControlModel) getSimulatorModel().getTextResource(getResourceKind());
            result =
                    controlModel == null || controlModel.isEnabled() ? grammar.getCtrlAut()
