...
abstract public class JEdge extends DefaultEdge implements JCell {
    ...
    /**
     * A j-edge is visible if it is not a source label, and its source and
    ...
    /**
     * Callback method from {@link #getToolTipText()} to describe the edge: kind
     * of edge, singular or multiple. The resulting string is interpreted as
     * HTML formatted
     */
