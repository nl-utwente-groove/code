...
/**
 * View renderer for PatternJEdges.
 * 
 * @author Eduardo Zambon
 */
public class PatternJEdgeView extends JEdgeView {
     ...
     */
    public PatternJEdgeView(PatternJEdge jEdge, PatternJGraph jGraph) {
        super(jEdge, jGraph);
    }

    /** Basic getter method. */
    @Override
    public PatternJEdge getCell() {
        return (PatternJEdge) super.getCell();
    }

    @Override
    public String toString() {
        return "PatternJEdgeView for " + this.getCell().toString();
    }
