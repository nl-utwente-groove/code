...
import groove.explore.DeprecatedGenerator.ResultOption;
import groove.explore.DeprecatedGenerator.TemplatedOption;
 ...
 * @deprecated use {@link ShapeGenerator} instead
 */
@Deprecated
public final class DeprecatedShapeGenerator extends CommandLineTool {
     ...
     * option classes.
     */
    public DeprecatedShapeGenerator(String... args) {
        super(args);
        this.strategyOption =
    ...
    private void reset() {
        ...
        this.explorationStats = new StatisticsReporter(this.getVerbosity());
    }
    ...
    public static void main(String[] args) {
        new DeprecatedShapeGenerator(args).start();
    }
    ...
    private class StatsOption implements CommandLineOption {
        ...
        public void parse(String parameter) {
            DeprecatedShapeGenerator.this.setPrintStats();
        }
    ...
    private class ReachabilityOption implements CommandLineOption {
        ...
        @Override
        public void parse(String parameter) {
            DeprecatedShapeGenerator.this.setReachability();
        }
