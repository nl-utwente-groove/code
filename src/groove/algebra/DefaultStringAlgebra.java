...
/**
 * Class specifying the algebra of strings and the available operations on
 * strings.
 * 
...
public class DefaultStringAlgebra extends Algebra {
    ...
    public Constant getConstant(String text) {
        try {
            return new StringConstant(ExprParser.toUnquoted(text,
    ...
    static public final String NAME =
    ...
    /**
     * Singleton instance of this class. This declaration needs to be here to
    ...
    private static abstract class StringString2BoolOperation extends
            DefaultOperation {
        /**
    ...
    static public class StringConstant extends DefaultConstant {
        /**
         * Constructs a string constant from a given non-<code>null</code>)
         * text. The text is the <i>content</i> of the string constant; i.e.,
         * it is already unquoted.
