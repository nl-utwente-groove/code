...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph role="graph" edgeids="false" edgemode="directed" id="start_four_ghosts">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n0">
        ...
        <node id="n21">
            <attr name="layout">
                <string>387 500 19 19</string>
            </attr>
        </node>
        <node id="n22">
            <attr name="layout">
                <string>279 512 19 19</string>
            </attr>
        </node>
        <node id="n25">
            <attr name="layout">
                <string>136 30 19 19</string>
            </attr>
        </node>
        <edge from="n0" to="n0">
            <attr name="label">
