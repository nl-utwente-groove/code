...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph edgemode="directed" edgeids="false" role="graph" id="equiv-test-2">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <attr name="$version">
        ...
        <edge to="n5" from="n0">
            ...
            <attr name="layout">
                <string>500 0 227 127 237 175 788 171 782 135 14</string>
            </attr>
        </edge>
        <edge to="n4" from="n4">
            <attr name="label">
