...
| [exploration-performance.md](exploration-performance.md) | Code-reading review (2026-09-20) of the exploration hot path: always-on instrumentation, dead optimisations, wrong-quantity scaling, allocation churn, structural gaps, plus the throughput harness needed to measure any of it. Harness (`test/performance/ExplorationBenchmark`), the `junit/performance` grammar set (16 grammars, quick and long tiers), baselines of both tiers and a coverage reassessment done by 2026-09-22; finding 3.11 fixed as gh #919 and 3.12 as gh #924 on their own branches, the rest not implemented. |
