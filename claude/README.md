...
| [tab-merge.md](tab-merge.md) | Merging the resource view tab (`AspectViewTab`, `TextTab` view mode) into the editor tab, with a display-level preview slot replacing the singleton main tab. Proposal with inventory and policy points; decided for after 8.0.0. |
