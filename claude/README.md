...
| [cow-edge-stores.md](cow-edge-stores.md) | Finding 4.3.2 of the exploration-performance review: forkable (copy-on-write) edge stores for copy mode. First implementation on `cow-edge-stores`, assessed 2026-09-24 (swing regression re-measured, edge-identity amendment); proposal to restrict it to copy mode awaiting decision. |
