...
| [download-stats.md](download-stats.md) | Download statistics from GitHub releases, SourceForge-style: daily counter snapshots differenced at render time, in a new `download-stats` repository. Design only, nothing implemented. |
