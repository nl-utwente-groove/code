...
| [confluent-diamond-state.md](confluent-diamond-state.md) | Finding 2.1 of the exploration-performance review: the confluent-diamond shortcut revived, with content-based event conflicts. Handoff state for branch `confluent-diamond`, in progress. |
