...
| [module-exports.md](module-exports.md) | What `module-info` exports now that 8.0.0 keeps it: the export list, why each forced export is there, the remaining `gui.view` leak with the two-session plan to close it, and the restructurings that would trim further. Branch `module-exports`, 2026-09-20. |
