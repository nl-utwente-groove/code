...
| [module-exports.md](module-exports.md) | What `module-info` exports now that 8.0.0 keeps it: the export list, why each forced export is there, the four remaining `-Xlint:exports` leaks and the restructurings that would trim further. Branch `worktree-module-exports`, 2026-09-20. |
