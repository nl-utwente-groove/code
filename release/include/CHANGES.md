...
- Platform-native installers for Windows, macOS and Linux with a bundled Java 25 runtime; the zips need Java 21+ and start without warnings on Java 24+
...
-------------------------------
- GTS export as control program now treats ultimate result state as final
...
Release 7.1.0, 28 March 2025
-------------------------------
- Added Disabled Rules to the system properties, overriding the rule-specific enabledness
- Added System Properties parameter (-P) to the Generator
- Resolved gh issues #833, #834, #835
