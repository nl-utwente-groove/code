...
public abstract class TypeExporter<E> implements Messenger, Visitor {
    ...
    protected @Nullable E getElement(Acceptor acceptor, java.lang.Object param) {
        return getElement(acceptor, param, false);
    }

    // If allowNull and element is not being set, returns null
    protected @Nullable E getElement(Acceptor acceptor, java.lang.Object param, boolean allowNull) {
