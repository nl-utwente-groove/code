...
public class ShapeGraph extends AGraph<HostNode,HostEdge> implements HostGraph {
    ...
    @Override
    public Set<@NonNull ShapeEdge> edgeSet() {
        return getCache().getEdgeSet();
    }

    @Override
    public Set<@NonNull ShapeNode> nodeSet() {
        return getCache().getNodeSet();
    }

    @Override
    @SuppressWarnings("unchecked")
    public Set<@NonNull ShapeEdge> edgeSet(Node node) {
        return (Set<ShapeEdge>) super.edgeSet(node);
    }

    @Override
    @SuppressWarnings("unchecked")
    public Set<@NonNull ShapeEdge> outEdgeSet(Node node) {
        return (Set<ShapeEdge>) super.outEdgeSet(node);
    }

    @Override
    @SuppressWarnings("unchecked")
    public Set<@NonNull ShapeEdge> inEdgeSet(Node node) {
    ...
    @Override
    public @NonNull ShapeCache getCache() {
    ...
    public Set<@NonNull EdgeSignature> getEdgeSigSet() {
