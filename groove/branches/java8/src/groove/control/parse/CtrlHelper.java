...
public class CtrlHelper {
    ...
    /** Returns a dot-separated string consisting of a positive number of token texts. */
    String flatten(List<?> children) {
        ...
        assert result != null : "Due to the fact that the loop is executed at least once";
