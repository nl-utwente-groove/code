...
public abstract class Line {
    ...
    abstract public <R extends Builder<R>> R toString(@NonNull LineFormat<R> renderer);
    ...
    static public class Composed extends Line {
        ...
        public <R extends Builder<R>> R toString(LineFormat<R> renderer) {
            ...
            @NonNull
            R[] fragments = (@NonNull R[]) new Builder[this.fragments.length];
    ...
    static public class Colored extends Line {
        ...
        @Override
        public <R extends Builder<R>> R toString(@NonNull LineFormat<R> renderer) {
