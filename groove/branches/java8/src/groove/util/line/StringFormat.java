 ...
 * @version $Revision $
 */
public class StringFormat extends LineFormat<StringFormat.@NonNull Builder> {
    @Override
    ...
    public static @NonNull StringFormat instance() {
        return instance;
    }

    private static final @NonNull StringFormat instance = new StringFormat();
