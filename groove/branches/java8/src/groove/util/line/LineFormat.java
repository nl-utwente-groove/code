 ...
 * @version $Revision $
 */
abstract public class LineFormat<R extends LineFormat.@NonNull Builder<R>> {
     ...
     */
    public @NonNull R applyComposed(@NonNull R[] fragments) {
        @NonNull
        R result;
    ...
    abstract public @NonNull R createResult();
