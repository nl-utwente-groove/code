...
public class CacheReference<C> extends SoftReference<@Nullable C> {
     ...
     */
    public @NonNull CacheReference<C> newReference(CacheHolder<C> holder, C cache) {
     ...
     */
    final public @NonNull CacheReference<C> newNullReference() {
     ...
     */
    final public @NonNull CacheReference<C> getNullReference(boolean strong) {
     ...
     * count.
     */
    private @NonNull CacheReference<C> getNullInstance(boolean strong, int incarnation) {
     ...
     */
    protected @NonNull CacheReference<C> createNullInstance(boolean strong, int incarnation) {
     ...
     * <code>true</code>.
     */
    private final List<@NonNull CacheReference<C>> strongNull; // = new
    // CacheReference<Object>(true);
    /**
     * Constant null reference, with {@link #isStrong()} set to
     * <code>false</code>.
     */
    private final List<@NonNull CacheReference<C>> softNull; // = new
     ...
     */
    static public <C> @NonNull CacheReference<C> newInstance() {
    ...
    static public <C> @NonNull CacheReference<C> newInstance(boolean strong) {
    ...
    static private final @NonNull CacheReference strongInstance = new CacheReference<Object>(true,
        0, null);
    /** The singleton null instance for weak references. */
    @SuppressWarnings("rawtypes")
    static private final @NonNull CacheReference softInstance = new CacheReference<Object>(false,
        0, null);
