...
abstract public class AbstractCacheHolder<C> implements CacheHolder<C> {
    ...
    @Override
    final public @NonNull CacheReference<C> getCacheReference() {
        return this.reference;
    }

    @Override
    final public void setCacheReference(@NonNull CacheReference<C> reference) {
     ...
     */
    protected @NonNull CacheReference<C> createNullReference(CacheReference<C> template) {
        if (template == null) {
    ...
    private @NonNull CacheReference<C> reference;
}
