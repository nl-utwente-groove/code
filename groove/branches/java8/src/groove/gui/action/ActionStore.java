...
public class ActionStore implements SimulatorListener {
    ...
    /** Returns the import action permanently associated with this simulator. */
    public ImportRulesAction getImportRulesAction() {
        // lazily create the action
        if (this.importRulesAction == null) {
            this.importRulesAction = new ImportRulesAction(this.simulator);
        }
        return this.importRulesAction;
    }

    /** The import action permanently associated with this simulator. */
    private ImportRulesAction importRulesAction;
