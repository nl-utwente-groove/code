...
abstract public class Display extends JPanel {
    ...
    public final Optional<ListPanel> getListPanel() {
        if (this.listPanel == null) {
            this.listPanel = createListPanel();
            if (this.listPanel.isPresent()) {
                ToolTipManager.sharedInstance().registerComponent(this.listPanel.get());
            }
        }
    ...
    private Optional<ListPanel> listPanel;

    /** Factory method for the optional list panel corresponding to this display. */
    protected Optional<ListPanel> createListPanel() {
        return Optional.of(new ListPanel(getList(), getListToolBar(), getKind()));
    }
    ...
    public static Display newDisplay(Simulator simulator, DisplayKind kind) {
        ...
        case TYPE:
            ...
            break;
        case FORMAT:
            result = new FormatDisplay(simulator);
            break;
        case PROPERTIES:
    ...
    /** Panel that contains a list of resources for this display. */
