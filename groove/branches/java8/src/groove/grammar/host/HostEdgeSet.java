 ...
 * @version $Revision $
 */
public final class HostEdgeSet extends HostEdgeTreeHashSet implements Set<@NonNull HostEdge> {
    ...
    /** Clones a given set. */
    public HostEdgeSet(Collection<@NonNull ? extends HostEdge> other) {
        super(other);
    }
     ...
     */
    final public static HostEdgeSet newInstance(Collection<@NonNull ? extends HostEdge> set) {
        HostEdgeSet result;
        if (set == null) {
