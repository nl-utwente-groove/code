...
public enum ResourceKind {
    ...
    /** External format resources. */
    FORMAT("Format", "format configuration", FileType.FORMAT, null);
    ...
    /**
     * Indicates if a given graph role
     * corresponds to a resource kind.
     */
    public static boolean isResource(GraphRole graphRole) {
        return toResource(graphRole) != null;
    }
    ...
    private static Map<GraphRole,ResourceKind> roleKindMap = new EnumMap<GraphRole,ResourceKind>(
        GraphRole.class);
    static {
