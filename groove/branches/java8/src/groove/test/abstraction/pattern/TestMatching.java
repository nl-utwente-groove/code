...
public class TestMatching {
    ...
    static private final Path GRAMMAR = Paths.get("junit/pattern/match-test.gps/");
    ...
    public static void setUp() {
        ...
        Path typeGraphFile = GRAMMAR.resolve(TYPE);
        try {
            view = GrammarModel.newInstance(GRAMMAR, false);
