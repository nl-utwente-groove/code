...
public class AbstrSimulationProperties extends Properties {
    ...
    /** */
    static public final Abstraction.LinkPrecision LINKPRECISION_DEFAULT_VALUE =
        Abstraction.LinkPrecision.HIGH;
    ...
    static {
        Map<String,Property<String>> defaultKeys =
            new LinkedHashMap<String,Property<String>>(5);
        defaultKeys.put(PRECISION_KEY, new Property.IsPositiveInteger(
            "Should be a natural number."));
        defaultKeys.put(RADIUS_KEY, new Property.IsPositiveInteger(
            "Should be a natural number."));
    ...
    public void update(Map<String,String> newValues) {
        for (Map.Entry<String,String> entry : newValues.entrySet()) {
            Object old = setProperty(entry.getKey(), entry.getValue());
            assert old != null : "Problem : the property " + entry.getKey()
                + " didn't exist.";
        }
    }
