...
public class GCLNewChecker extends TreeParser {
    ...
    public final GCLNewChecker.function_return function() throws RecognitionException {
        ...
        try {
            ...
            match(input, Token.DOWN, null); 
            _last = (CommonTree)input.LT(1);
            ID6=(CommonTree)match(input,ID,FOLLOW_ID_in_function98); 
            ...
            if ( _first_1==null ) _first_1 = block7.tree;
              		...
              		if (namespace.hasRule((ID6!=null?ID6.getText():null))) {
              			errors.add("There already exists a rule with the name: "+(ID6!=null?ID6.getText():null));
              		}
            ...
            if ( input.LA(1)==Token.DOWN ) {
                ...
                do {
                	...
                	case 1 :
                	    ...
                	    if ( _first_1==null ) _first_1 = stat9.tree;
        ...
        try {
            ...
            switch (alt6) {
                ...
                case 2 :
                    ...
                    if ( _first_0==null ) _first_0 = var_decl11.tree;
                ...
                case 3 :
                    ...
                    CommonTree _first_1 = null;
                    _last = (CommonTree)input.LT(1);
                    ALAP12=(CommonTree)match(input,ALAP,FOLLOW_ALAP_in_stat153); 


                    if ( _first_0==null ) _first_0 = ALAP12;
                    match(input, Token.DOWN, null); 
                    _last = (CommonTree)input.LT(1);
                    ...
                    if ( _first_1==null ) _first_1 = stat13.tree;
                ...
                case 4 :
                    ...
                    CommonTree _first_1 = null;
                    _last = (CommonTree)input.LT(1);
                    WHILE14=(CommonTree)match(input,WHILE,FOLLOW_WHILE_in_stat163); 
                    ...
                    if ( _first_1==null ) _first_1 = stat15.tree;
                    _last = (CommonTree)input.LT(1);
                ...
                case 5 :
                    ...
                    CommonTree _first_1 = null;
                    _last = (CommonTree)input.LT(1);
                    UNTIL17=(CommonTree)match(input,UNTIL,FOLLOW_UNTIL_in_stat175); 


                    if ( _first_0==null ) _first_0 = UNTIL17;
                    match(input, Token.DOWN, null); 
                    _last = (CommonTree)input.LT(1);
                    ...
                    if ( _first_1==null ) _first_1 = stat18.tree;
                    _last = (CommonTree)input.LT(1);
                ...
                case 6 :
                    ...
                    CommonTree _first_1 = null;
                    _last = (CommonTree)input.LT(1);
                    TRY20=(CommonTree)match(input,TRY,FOLLOW_TRY_in_stat187); 


                    if ( _first_0==null ) _first_0 = TRY20;
                    match(input, Token.DOWN, null); 
                    _last = (CommonTree)input.LT(1);
                ...
                case 7 :
                    ...
                    CommonTree _first_1 = null;
                    _last = (CommonTree)input.LT(1);
                    IF23=(CommonTree)match(input,IF,FOLLOW_IF_in_stat202); 
                ...
                case 8 :
                    ...
                    CommonTree _first_1 = null;
                    _last = (CommonTree)input.LT(1);
                    CHOICE27=(CommonTree)match(input,CHOICE,FOLLOW_CHOICE_in_stat219); 


                    if ( _first_0==null ) _first_0 = CHOICE27;
                    match(input, Token.DOWN, null); 
                ...
                case 9 :
                    ...
                    CommonTree _first_1 = null;
                    _last = (CommonTree)input.LT(1);
                    STAR29=(CommonTree)match(input,STAR,FOLLOW_STAR_in_stat230); 


                    if ( _first_0==null ) _first_0 = STAR29;
                    match(input, Token.DOWN, null); 
                    _last = (CommonTree)input.LT(1);
                ...
                case 10 :
                    ...
                    if ( _first_0==null ) _first_0 = rule31.tree;
                ...
                case 11 :
                    ...
                    {
                    _last = (CommonTree)input.LT(1);
                    ANY32=(CommonTree)match(input,ANY,FOLLOW_ANY_in_stat245); 
                     
                    if ( _first_0==null ) _first_0 = ANY32;
                ...
                case 12 :
                    ...
                    {
                    _last = (CommonTree)input.LT(1);
                    OTHER33=(CommonTree)match(input,OTHER,FOLLOW_OTHER_in_stat251); 
                     
                    if ( _first_0==null ) _first_0 = OTHER33;
                ...
                case 13 :
                    ...
                    {
                    _last = (CommonTree)input.LT(1);
                    TRUE34=(CommonTree)match(input,TRUE,FOLLOW_TRUE_in_stat257); 
                     
                    if ( _first_0==null ) _first_0 = TRUE34;
    ...
    public final GCLNewChecker.rule_return rule() throws RecognitionException {
        ...
        try {
            ...
            CommonTree _first_1 = null;
            _last = (CommonTree)input.LT(1);
            CALL35=(CommonTree)match(input,CALL,FOLLOW_CALL_in_rule271); 


            if ( _first_0==null ) _first_0 = CALL35;
            match(input, Token.DOWN, null); 
            _last = (CommonTree)input.LT(1);
            r=(CommonTree)match(input,ID,FOLLOW_ID_in_rule275); 
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    if ( _first_1==null ) _first_1 = arg36.tree;
    ...
    public final GCLNewChecker.var_decl_return var_decl() throws RecognitionException {
        ...
        try {
            ...
            CommonTree _first_1 = null;
            _last = (CommonTree)input.LT(1);
            VAR37=(CommonTree)match(input,VAR,FOLLOW_VAR_in_var_decl297); 


            if ( _first_0==null ) _first_0 = VAR37;
            match(input, Token.DOWN, null); 
            _last = (CommonTree)input.LT(1);
            ...
            _last = (CommonTree)input.LT(1);
            ID38=(CommonTree)match(input,ID,FOLLOW_ID_in_var_decl321); 
             
            if ( _first_1==null ) _first_1 = ID38;
             
            		if (!namespace.hasVariable((ID38!=null?ID38.getText():null))) {
            			namespace.addVariable((ID38!=null?ID38.getText():null)); 
            			st.declareSymbol((ID38!=null?ID38.getText():null), t.getText());
            		} else {
            			errors.add("Double declaration of variable '"+(ID38!=null?ID38.getText():null)+"' on line "+(ID38!=null?ID38.getLine():0));
            		}
        ...
        try {
            ...
            switch (alt8) {
                case 1 :
                    ...
                    CommonTree _first_1 = null;
                    _last = (CommonTree)input.LT(1);
                    ARG39=(CommonTree)match(input,ARG,FOLLOW_ARG_in_arg337); 


                    if ( _first_0==null ) _first_0 = ARG39;
                    match(input, Token.DOWN, null); 
                    _last = (CommonTree)input.LT(1);
                    ID40=(CommonTree)match(input,ID,FOLLOW_ID_in_arg339); 
                     
                    if ( _first_1==null ) _first_1 = ID40;

                    			numParameters++;
                    			if (st.isDeclared((ID40!=null?ID40.getText():null))) {
                    				if (!st.isInitialized((ID40!=null?ID40.getText():null))) {
                    					errors.add("The variable "+(ID40!=null?ID40.getText():null)+" might not have been initialized on line "+(ID40!=null?ID40.getLine():0));
                    				}
                    			} else {
                    				errors.add("No such variable: "+(ID40!=null?ID40.getText():null));
                    			}
                    			if (currentRule != null && currentRule.getNumberOfParameters() < numParameters) {
                    				errors.add("Rule "+currentRule.getName().toString()+" does not have this many parameters on line "+(ID40!=null?ID40.getLine():0)); 
                    			} else {
                    				if (currentRule != null && !currentRule.isInputParameter(numParameters)) {
                    					errors.add("Parameter number "+(numParameters)+" cannot be an input parameter in rule "+currentRule.getName().toString()+" on line "+(ID40!=null?ID40.getLine():0));
                    				}
                    				if (currentRule != null && !currentRule.getAttributeParameterType(numParameters).equals(st.getType((ID40!=null?ID40.getText():null)))) {
                    					errors.add("Type mismatch between parameter "+numParameters+" of "+currentRule.getName().toString()+" and variable "+(ID40!=null?ID40.getText():null)+" ("+currentRule.getAttributeParameterType(numParameters)+" is not "+st.getType((ID40!=null?ID40.getText():null))+")");
                    				}
                    			}
                ...
                case 2 :
                    ...
                    CommonTree _first_1 = null;
                    _last = (CommonTree)input.LT(1);
                    ARG41=(CommonTree)match(input,ARG,FOLLOW_ARG_in_arg349); 


                    if ( _first_0==null ) _first_0 = ARG41;
                    match(input, Token.DOWN, null); 
                    _last = (CommonTree)input.LT(1);
                    OUT42=(CommonTree)match(input,OUT,FOLLOW_OUT_in_arg351); 
                     
                    if ( _first_1==null ) _first_1 = OUT42;
                    _last = (CommonTree)input.LT(1);
                    ID43=(CommonTree)match(input,ID,FOLLOW_ID_in_arg353); 
                     
                    if ( _first_1==null ) _first_1 = ID43;

                    			numParameters++;
                    			
                    			if (st.isDeclared((ID43!=null?ID43.getText():null))) {
                    				if (!st.canInitialize((ID43!=null?ID43.getText():null)) || syntaxInit.contains((ID43!=null?ID43.getText():null))) {
                    					errors.add("Variable already initialized: "+(ID43!=null?ID43.getText():null)+" on line "+(ID43!=null?ID43.getLine():0));
                    				} else {
                    					st.initializeSymbol((ID43!=null?ID43.getText():null));
                    					syntaxInit.add((ID43!=null?ID43.getText():null));
                    				}
                    			} else {
                    				errors.add("No such variable: "+(ID43!=null?ID43.getText():null)+" on line "+(ID43!=null?ID43.getLine():0));
                    			}
                    			if (currentRule != null && currentRule.getNumberOfParameters() < numParameters) {
                    				errors.add("Rule "+currentRule.getName().toString()+" does not have this many parameters on line "+(ID43!=null?ID43.getLine():0)); 
                    			} else {
                    				if (currentRule != null && !currentRule.isOutputParameter(numParameters)) {
                    					errors.add("Parameter number "+(numParameters)+" cannot be an output parameter in rule "+currentRule.getName().toString()+" on line "+(ID43!=null?ID43.getLine():0));
                    				}
                    				if (currentOutputParameters.contains((ID43!=null?ID43.getText():null))) {
                    					errors.add("You can not use the same parameter as output more than once per call: "+(ID43!=null?ID43.getText():null)+" on line "+(ID43!=null?ID43.getLine():0));			
                    				}
                    				if (currentRule != null && !currentRule.getAttributeParameterType(numParameters).equals(st.getType((ID43!=null?ID43.getText():null)))) {
                    					errors.add("Type mismatch between parameter "+numParameters+" of "+currentRule.getName().toString()+" and variable "+(ID43!=null?ID43.getText():null)+" ("+currentRule.getAttributeParameterType(numParameters)+" is not "+st.getType((ID43!=null?ID43.getText():null))+")");
                    				}
                    			...
                    			currentOutputParameters.add((ID43!=null?ID43.getText():null));
                ...
                case 3 :
                    ...
                    CommonTree _first_1 = null;
                    _last = (CommonTree)input.LT(1);
                    ARG44=(CommonTree)match(input,ARG,FOLLOW_ARG_in_arg363); 


                    if ( _first_0==null ) _first_0 = ARG44;
                    match(input, Token.DOWN, null); 
                    _last = (CommonTree)input.LT(1);
                    DONT_CARE45=(CommonTree)match(input,DONT_CARE,FOLLOW_DONT_CARE_in_arg365); 
                     
                    if ( _first_1==null ) _first_1 = DONT_CARE45;
                ...
                case 4 :
                    ...
                    CommonTree _first_1 = null;
                    _last = (CommonTree)input.LT(1);
                    ARG46=(CommonTree)match(input,ARG,FOLLOW_ARG_in_arg374); 


                    if ( _first_0==null ) _first_0 = ARG46;
                    match(input, Token.DOWN, null); 
                    _last = (CommonTree)input.LT(1);
                    BOOL_TYPE47=(CommonTree)match(input,BOOL_TYPE,FOLLOW_BOOL_TYPE_in_arg376); 
                     
                    if ( _first_1==null ) _first_1 = BOOL_TYPE47;
                    _last = (CommonTree)input.LT(1);
                    bool=(CommonTree)input.LT(1);
                ...
                case 5 :
                    ...
                    CommonTree _first_1 = null;
                    _last = (CommonTree)input.LT(1);
                    ARG48=(CommonTree)match(input,ARG,FOLLOW_ARG_in_arg393); 


                    if ( _first_0==null ) _first_0 = ARG48;
                    match(input, Token.DOWN, null); 
                    _last = (CommonTree)input.LT(1);
                    STRING_TYPE49=(CommonTree)match(input,STRING_TYPE,FOLLOW_STRING_TYPE_in_arg395); 
                     
                    if ( _first_1==null ) _first_1 = STRING_TYPE49;
                    _last = (CommonTree)input.LT(1);
                    str=(CommonTree)match(input,ID,FOLLOW_ID_in_arg399); 
                ...
                case 6 :
                    ...
                    CommonTree _first_1 = null;
                    _last = (CommonTree)input.LT(1);
                    ARG50=(CommonTree)match(input,ARG,FOLLOW_ARG_in_arg408); 


                    if ( _first_0==null ) _first_0 = ARG50;
                    match(input, Token.DOWN, null); 
                    _last = (CommonTree)input.LT(1);
                    INT_TYPE51=(CommonTree)match(input,INT_TYPE,FOLLOW_INT_TYPE_in_arg410); 
                     
                    if ( _first_1==null ) _first_1 = INT_TYPE51;
                    _last = (CommonTree)input.LT(1);
                    in=(CommonTree)match(input,ID,FOLLOW_ID_in_arg414); 
                ...
                case 7 :
                    ...
                    CommonTree _first_1 = null;
                    _last = (CommonTree)input.LT(1);
                    ARG52=(CommonTree)match(input,ARG,FOLLOW_ARG_in_arg423); 


                    if ( _first_0==null ) _first_0 = ARG52;
                    match(input, Token.DOWN, null); 
                    _last = (CommonTree)input.LT(1);
                    REAL_TYPE53=(CommonTree)match(input,REAL_TYPE,FOLLOW_REAL_TYPE_in_arg425); 
                     
                    if ( _first_1==null ) _first_1 = REAL_TYPE53;
                    _last = (CommonTree)input.LT(1);
                    r=(CommonTree)match(input,ID,FOLLOW_ID_in_arg429); 
    ...
    public static final BitSet FOLLOW_ID_in_function98 = new BitSet(new long[]{0x0000000000000020L});
    ...
    public static final BitSet FOLLOW_stat_in_block122 = new BitSet(new long[]{0x0000000351AE0528L});
    public static final BitSet FOLLOW_block_in_stat140 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_var_decl_in_stat146 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ALAP_in_stat153 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_stat_in_stat155 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_WHILE_in_stat163 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_stat_in_stat165 = new BitSet(new long[]{0x0000000351AE0528L});
    public static final BitSet FOLLOW_stat_in_stat167 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_UNTIL_in_stat175 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_stat_in_stat177 = new BitSet(new long[]{0x0000000351AE0528L});
    public static final BitSet FOLLOW_stat_in_stat179 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_TRY_in_stat187 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_stat_in_stat189 = new BitSet(new long[]{0x0000000351AE0528L});
    public static final BitSet FOLLOW_stat_in_stat192 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_IF_in_stat202 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_stat_in_stat204 = new BitSet(new long[]{0x0000000351AE0528L});
    public static final BitSet FOLLOW_stat_in_stat206 = new BitSet(new long[]{0x0000000351AE0528L});
    public static final BitSet FOLLOW_stat_in_stat209 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_CHOICE_in_stat219 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_stat_in_stat221 = new BitSet(new long[]{0x0000000351AE0528L});
    public static final BitSet FOLLOW_STAR_in_stat230 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_stat_in_stat232 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_rule_in_stat239 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ANY_in_stat245 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_OTHER_in_stat251 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_TRUE_in_stat257 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_CALL_in_rule271 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_ID_in_rule275 = new BitSet(new long[]{0x0000000000000808L});
    public static final BitSet FOLLOW_arg_in_rule279 = new BitSet(new long[]{0x0000000000000808L});
    public static final BitSet FOLLOW_VAR_in_var_decl297 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_set_in_var_decl301 = new BitSet(new long[]{0x0000000000004000L});
    public static final BitSet FOLLOW_ID_in_var_decl321 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_ARG_in_arg337 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_ID_in_arg339 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_ARG_in_arg349 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_OUT_in_arg351 = new BitSet(new long[]{0x0000000000004000L});
    public static final BitSet FOLLOW_ID_in_arg353 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_ARG_in_arg363 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_DONT_CARE_in_arg365 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_ARG_in_arg374 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_BOOL_TYPE_in_arg376 = new BitSet(new long[]{0x0000080010000000L});
    public static final BitSet FOLLOW_set_in_arg380 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_ARG_in_arg393 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_STRING_TYPE_in_arg395 = new BitSet(new long[]{0x0000000000004000L});
    public static final BitSet FOLLOW_ID_in_arg399 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_ARG_in_arg408 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_INT_TYPE_in_arg410 = new BitSet(new long[]{0x0000000000004000L});
    public static final BitSet FOLLOW_ID_in_arg414 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_ARG_in_arg423 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_REAL_TYPE_in_arg425 = new BitSet(new long[]{0x0000000000004000L});
    public static final BitSet FOLLOW_ID_in_arg429 = new BitSet(new long[]{0x0000000000000008L});
