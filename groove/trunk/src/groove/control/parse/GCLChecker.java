// $ANTLR 3.2 Sep 23, 2009 12:02:23 GCLChecker.g 2010-11-28 10:12:14
...
public class GCLChecker extends TreeParser {
    ...
    // $ANTLR start "program"
    // GCLChecker.g:57:1: program : ^( PROGRAM functions block ) ;
    public final GCLChecker.program_return program()
        ...
        try {
            // GCLChecker.g:58:3: ( ^( PROGRAM functions block ) )
            // GCLChecker.g:58:6: ^( PROGRAM functions block )
            {
    ...
    // GCLChecker.g:61:1: functions : ^(f= FUNCTIONS ( function )* ) ;
    public final GCLChecker.functions_return functions()
        ...
        try {
            // GCLChecker.g:62:3: ( ^(f= FUNCTIONS ( function )* ) )
            // GCLChecker.g:62:5: ^(f= FUNCTIONS ( function )* )
            {
                _last = (CommonTree) this.input.LT(1);
                {
                    CommonTree _save_last_1 = _last;
    ...
    // GCLChecker.g:64:1: function : ^( FUNCTION IDENTIFIER block ) ;
    public final GCLChecker.function_return function()
        ...
        try {
            // GCLChecker.g:65:3: ( ^( FUNCTION IDENTIFIER block ) )
            // GCLChecker.g:65:5: ^( FUNCTION IDENTIFIER block )
            {
                _last = (CommonTree) this.input.LT(1);
                {
                    CommonTree _save_last_1 = _last;
    ...
    // $ANTLR start "block"
    // GCLChecker.g:72:1: block : ^( BLOCK ( statement )* ) ;
    public final GCLChecker.block_return block() throws RecognitionException {
        ...
        try {
            // GCLChecker.g:73:3: ( ^( BLOCK ( statement )* ) )
            // GCLChecker.g:73:5: ^( BLOCK ( statement )* )
            {
                _last = (CommonTree) this.input.LT(1);
                {
                    CommonTree _save_last_1 = _last;
    ...
    // GCLChecker.g:76:1: statement : ( ^( ALAP block ) | ^( WHILE condition block ) | ^( UNTIL condition block ) | ^( DO block condition ) | ^( TRY block ( block )? ) | ^( IF condition block ( block )? ) | ^( CHOICE ( block )+ ) | expression | var_declaration );
    public final GCLChecker.statement_return statement()
        ...
        try {
            // GCLChecker.g:77:3: ( ^( ALAP block ) | ^( WHILE condition block ) | ^( UNTIL condition block ) | ^( DO block condition ) | ^( TRY block ( block )? ) | ^( IF condition block ( block )? ) | ^( CHOICE ( block )+ ) | expression | var_declaration )
            int alt6 = 9;
                ...
                // GCLChecker.g:77:5: ^( ALAP block )
            {
                ...
                break;
            case 2:
                // GCLChecker.g:78:5: ^( WHILE condition block )
            {
                _last = (CommonTree) this.input.LT(1);
                {
                    CommonTree _save_last_1 = _last;
                ...
                break;
            case 3:
                // GCLChecker.g:79:5: ^( UNTIL condition block )
            {
                _last = (CommonTree) this.input.LT(1);
                {
                    CommonTree _save_last_1 = _last;
                ...
                break;
            case 4:
                // GCLChecker.g:80:5: ^( DO block condition )
            {
                _last = (CommonTree) this.input.LT(1);
                {
                    CommonTree _save_last_1 = _last;
                ...
                break;
            case 5:
                // GCLChecker.g:81:5: ^( TRY block ( block )? )
            {
                _last = (CommonTree) this.input.LT(1);
                {
                    CommonTree _save_last_1 = _last;
                ...
                break;
            case 6:
                // GCLChecker.g:82:5: ^( IF condition block ( block )? )
            {
                _last = (CommonTree) this.input.LT(1);
                {
                    CommonTree _save_last_1 = _last;
                ...
                break;
            case 7:
                // GCLChecker.g:83:5: ^( CHOICE ( block )+ )
            {
                _last = (CommonTree) this.input.LT(1);
                {
                    CommonTree _save_last_1 = _last;
                ...
                // GCLChecker.g:84:5: expression
            {
                ...
                break;
            case 9:
                // GCLChecker.g:85:5: var_declaration
            {
                _last = (CommonTree) this.input.LT(1);
    ...
    // GCLChecker.g:88:1: expression : ( ^( OR expression expression ) | ^( PLUS e1= expression ) -> ^( PLUS $e1 $e1) | ^( STAR expression ) | ^( SHARP expression ) | rule | ANY | OTHER );
    public final GCLChecker.expression_return expression()
        ...
        try {
            // GCLChecker.g:89:2: ( ^( OR expression expression ) | ^( PLUS e1= expression ) -> ^( PLUS $e1 $e1) | ^( STAR expression ) | ^( SHARP expression ) | rule | ANY | OTHER )
            int alt7 = 7;
            switch (this.input.LA(1)) {
            case OR: {
                alt7 = 1;
            ...
            switch (alt7) {
            case 1:
                // GCLChecker.g:89:4: ^( OR expression expression )
            {
                _last = (CommonTree) this.input.LT(1);
                {
                    CommonTree _save_last_1 = _last;
                ...
                break;
            case 2:
                // GCLChecker.g:90:4: ^( PLUS e1= expression )
            {
                _last = (CommonTree) this.input.LT(1);
                {
                    CommonTree _save_last_1 = _last;
                ...
                break;
            case 3:
                // GCLChecker.g:91:4: ^( STAR expression )
            {
                _last = (CommonTree) this.input.LT(1);
                {
                    CommonTree _save_last_1 = _last;
                ...
                break;
            case 4:
                // GCLChecker.g:92:4: ^( SHARP expression )
            {
                _last = (CommonTree) this.input.LT(1);
                {
                    CommonTree _save_last_1 = _last;
    ...
    // GCLChecker.g:98:1: condition : ( ^( OR condition condition ) | rule | TRUE );
    public final GCLChecker.condition_return condition()
        ...
        try {
            // GCLChecker.g:99:3: ( ^( OR condition condition ) | rule | TRUE )
            int alt8 = 3;
            switch (this.input.LA(1)) {
            case OR: {
                alt8 = 1;
            ...
            switch (alt8) {
            case 1:
                // GCLChecker.g:99:5: ^( OR condition condition )
            {
                _last = (CommonTree) this.input.LT(1);
                {
                    CommonTree _save_last_1 = _last;
    ...
    // $ANTLR start "rule"
    // GCLChecker.g:104:1: rule : ^( CALL r= IDENTIFIER ( param )* ) ;
    public final GCLChecker.rule_return rule() throws RecognitionException {
        ...
        try {
            // GCLChecker.g:105:3: ( ^( CALL r= IDENTIFIER ( param )* ) )
            // GCLChecker.g:105:5: ^( CALL r= IDENTIFIER ( param )* )
            {
                _last = (CommonTree) this.input.LT(1);
                {
                    CommonTree _save_last_1 = _last;
                    ...
                    if (this.currentRule != null) {
                        this.currentSig = this.currentRule.getSignature();
                    }

                    // GCLChecker.g:111:5: ( param )*
                    loop9: do {
                        int alt9 = 2;
                        ...
                        {
                            _last = (CommonTree) this.input.LT(1);
                            pushFollow(FOLLOW_param_in_rule372);
                            param49 = param();
                    ...
                    if (!this.namespace.hasRule((r != null ? r.getText() : null))
                        ...
                        && this.numParameters != this.currentSig.size()) {
    ...
    // GCLChecker.g:128:1: var_declaration : ^( VAR t= ( NODE_TYPE | BOOL_TYPE | STRING_TYPE | INT_TYPE | REAL_TYPE ) IDENTIFIER ) ;
    public final GCLChecker.var_declaration_return var_declaration()
        ...
        try {
            // GCLChecker.g:129:2: ( ^( VAR t= ( NODE_TYPE | BOOL_TYPE | STRING_TYPE | INT_TYPE | REAL_TYPE ) IDENTIFIER ) )
            // GCLChecker.g:129:4: ^( VAR t= ( NODE_TYPE | BOOL_TYPE | STRING_TYPE | INT_TYPE | REAL_TYPE ) IDENTIFIER )
            {
                _last = (CommonTree) this.input.LT(1);
                {
                    CommonTree _save_last_1 = _last;
                    ...
                    VAR50 =
                        (CommonTree) match(this.input, VAR,
                            FOLLOW_VAR_in_var_declaration395);
                    ...
                    IDENTIFIER51 =
                        (CommonTree) match(this.input, IDENTIFIER,
                            FOLLOW_IDENTIFIER_in_var_declaration419);
    ...
    // $ANTLR start "param"
    // GCLChecker.g:139:1: param : ( ^( PARAM IDENTIFIER ) | ^( PARAM OUT IDENTIFIER ) | ^( PARAM DONT_CARE ) | ^( PARAM BOOL_TYPE bool= ( TRUE | FALSE ) ) | ^( PARAM STRING_TYPE str= IDENTIFIER ) | ^( PARAM INT_TYPE in= IDENTIFIER ) | ^( PARAM REAL_TYPE r= IDENTIFIER ) );
    public final GCLChecker.param_return param() throws RecognitionException {
        ...
        if (this.numParameters <= this.currentSig.size()) {
            currentPar = this.currentSig.get(this.numParameters - 1);
            currentParType = currentPar.getType().toString();
        }

        try {
            // GCLChecker.g:149:2: ( ^( PARAM IDENTIFIER ) | ^( PARAM OUT IDENTIFIER ) | ^( PARAM DONT_CARE ) | ^( PARAM BOOL_TYPE bool= ( TRUE | FALSE ) ) | ^( PARAM STRING_TYPE str= IDENTIFIER ) | ^( PARAM INT_TYPE in= IDENTIFIER ) | ^( PARAM REAL_TYPE r= IDENTIFIER ) )
            int alt10 = 7;
            alt10 = this.dfa10.predict(this.input);
            switch (alt10) {
            case 1:
                // GCLChecker.g:149:4: ^( PARAM IDENTIFIER )
            {
                _last = (CommonTree) this.input.LT(1);
                {
                    CommonTree _save_last_1 = _last;
                    ...
                    if (this.currentRule != null
                        && this.currentSig.size() < this.numParameters) {
                        ...
                        if (this.currentRule != null && currentPar.isOutOnly()) {
                        ...
                        if (this.currentRule != null
                            && !currentPar.getType().toString().equals(
                ...
                break;
            case 2:
                // GCLChecker.g:168:4: ^( PARAM OUT IDENTIFIER )
            {
                _last = (CommonTree) this.input.LT(1);
                {
                    CommonTree _save_last_1 = _last;
                    ...
                    if (this.currentRule != null
                        ...
                        if (this.currentRule != null
                            && !currentParType.equals(this.st.getType((IDENTIFIER56 != null
                                    ? IDENTIFIER56.getText() : null)))) {
                            this.errors.add("Type mismatch between parameter "
                                + this.numParameters
                                + " of "
                        ...
                        if (this.currentRule != null && currentPar.isInOnly()) {
                ...
                break;
            case 3:
                // GCLChecker.g:194:4: ^( PARAM DONT_CARE )
            {
                _last = (CommonTree) this.input.LT(1);
                {
                    CommonTree _save_last_1 = _last;
                ...
                break;
            case 4:
                // GCLChecker.g:199:4: ^( PARAM BOOL_TYPE bool= ( TRUE | FALSE ) )
            {
                _last = (CommonTree) this.input.LT(1);
                {
                    CommonTree _save_last_1 = _last;
                    ...
                    if (this.currentRule != null
                        && !currentPar.getType().toString().equals("bool")) {
                        this.errors.add("Type mismatch between parameter "
                            + this.numParameters + " of "
                            + this.currentRule.getName().toString() + " and '"
                            + bool.getText() + "' on line " + bool.getLine()
                            + " (" + currentParType + " is not bool)");
                    }
                ...
                break;
            case 5:
                // GCLChecker.g:204:4: ^( PARAM STRING_TYPE str= IDENTIFIER )
            {
                _last = (CommonTree) this.input.LT(1);
                {
                    CommonTree _save_last_1 = _last;
                    ...
                    STRING_TYPE62 =
                        (CommonTree) match(this.input, STRING_TYPE,
                            FOLLOW_STRING_TYPE_in_param497);
                    ...
                    if (this.currentRule != null
                        && !currentPar.getType().toString().equals("string")) {
                        this.errors.add("Type mismatch between parameter "
                            + this.numParameters + " of "
                            + this.currentRule.getName().toString() + " and "
                            + str.getText() + " on line " + str.getLine()
                            + " (" + currentParType + " is not string)");
                    }
                ...
                break;
            case 6:
                // GCLChecker.g:209:4: ^( PARAM INT_TYPE in= IDENTIFIER )
            {
                _last = (CommonTree) this.input.LT(1);
                {
                    CommonTree _save_last_1 = _last;
                    ...
                    if (this.currentRule != null
                        && !currentPar.getType().toString().equals("int")) {
                        this.errors.add("Type mismatch between parameter "
                            + this.numParameters + " of "
                            + this.currentRule.getName().toString() + " and '"
                            + in.getText() + "' on line " + in.getLine() + " ("
                            + currentParType + " is not int)");
                    }
                ...
                break;
            case 7:
                // GCLChecker.g:214:4: ^( PARAM REAL_TYPE r= IDENTIFIER )
            {
                _last = (CommonTree) this.input.LT(1);
                {
                    CommonTree _save_last_1 = _last;
                    ...
                    if (this.currentRule != null
                        && !currentPar.getType().toString().equals("real")) {
                        this.errors.add("Type mismatch between parameter "
                            + this.numParameters + " of "
                            + this.currentRule.getName().toString() + " and '"
                            + r.getText() + "' on line " + r.getLine() + " ("
                            + currentParType + " is not real)");
                    }
    ...
    static final String[] DFA10_transitionS = {"\1\1", "\1\2",
    ...
    class DFA10 extends DFA {
        ...
        public String getDescription() {
            return "139:1: param : ( ^( PARAM IDENTIFIER ) | ^( PARAM OUT IDENTIFIER ) | ^( PARAM DONT_CARE ) | ^( PARAM BOOL_TYPE bool= ( TRUE | FALSE ) ) | ^( PARAM STRING_TYPE str= IDENTIFIER ) | ^( PARAM INT_TYPE in= IDENTIFIER ) | ^( PARAM REAL_TYPE r= IDENTIFIER ) );";
        }
    }
    ...
    public static final BitSet FOLLOW_FUNCTION_in_function96 = new BitSet(
        new long[] {0x0000000000000004L});
    public static final BitSet FOLLOW_IDENTIFIER_in_function98 = new BitSet(
        new long[] {0x0000000000000020L});
    ...
    public static final BitSet FOLLOW_BLOCK_in_block117 = new BitSet(
        new long[] {0x0000000000000004L});
    public static final BitSet FOLLOW_statement_in_block122 = new BitSet(
        new long[] {0x000000000FABE708L});
    public static final BitSet FOLLOW_ALAP_in_statement141 = new BitSet(
        new long[] {0x0000000000000004L});
    public static final BitSet FOLLOW_block_in_statement143 = new BitSet(
        new long[] {0x0000000000000008L});
    public static final BitSet FOLLOW_WHILE_in_statement151 = new BitSet(
        new long[] {0x0000000000000004L});
    public static final BitSet FOLLOW_condition_in_statement153 = new BitSet(
        new long[] {0x0000000000000020L});
    public static final BitSet FOLLOW_block_in_statement155 = new BitSet(
        new long[] {0x0000000000000008L});
    public static final BitSet FOLLOW_UNTIL_in_statement163 = new BitSet(
        new long[] {0x0000000000000004L});
    public static final BitSet FOLLOW_condition_in_statement165 = new BitSet(
        new long[] {0x0000000000000020L});
    public static final BitSet FOLLOW_block_in_statement167 = new BitSet(
        new long[] {0x0000000000000008L});
    public static final BitSet FOLLOW_DO_in_statement175 = new BitSet(
        new long[] {0x0000000000000004L});
    public static final BitSet FOLLOW_block_in_statement177 = new BitSet(
        new long[] {0x0000000000402100L});
    public static final BitSet FOLLOW_condition_in_statement179 = new BitSet(
        new long[] {0x0000000000000008L});
    public static final BitSet FOLLOW_TRY_in_statement187 = new BitSet(
        new long[] {0x0000000000000004L});
    public static final BitSet FOLLOW_block_in_statement189 = new BitSet(
        new long[] {0x0000000000000028L});
    public static final BitSet FOLLOW_block_in_statement192 = new BitSet(
        new long[] {0x0000000000000008L});
    public static final BitSet FOLLOW_IF_in_statement202 = new BitSet(
        new long[] {0x0000000000000004L});
    public static final BitSet FOLLOW_condition_in_statement204 = new BitSet(
        new long[] {0x0000000000000020L});
    public static final BitSet FOLLOW_block_in_statement206 = new BitSet(
        new long[] {0x0000000000000028L});
    public static final BitSet FOLLOW_block_in_statement209 = new BitSet(
        new long[] {0x0000000000000008L});
    public static final BitSet FOLLOW_CHOICE_in_statement219 = new BitSet(
        new long[] {0x0000000000000004L});
    public static final BitSet FOLLOW_block_in_statement221 = new BitSet(
        new long[] {0x0000000000000028L});
    public static final BitSet FOLLOW_expression_in_statement229 = new BitSet(
        new long[] {0x0000000000000002L});
    public static final BitSet FOLLOW_var_declaration_in_statement235 =
        new BitSet(new long[] {0x0000000000000002L});
    public static final BitSet FOLLOW_OR_in_expression249 = new BitSet(
        new long[] {0x0000000000000004L});
    public static final BitSet FOLLOW_expression_in_expression251 = new BitSet(
        new long[] {0x000000000F802100L});
    public static final BitSet FOLLOW_expression_in_expression253 = new BitSet(
        new long[] {0x0000000000000008L});
    public static final BitSet FOLLOW_PLUS_in_expression260 = new BitSet(
        new long[] {0x0000000000000004L});
    public static final BitSet FOLLOW_expression_in_expression264 = new BitSet(
        new long[] {0x0000000000000008L});
    public static final BitSet FOLLOW_STAR_in_expression283 = new BitSet(
        new long[] {0x0000000000000004L});
    public static final BitSet FOLLOW_expression_in_expression285 = new BitSet(
        new long[] {0x0000000000000008L});
    public static final BitSet FOLLOW_SHARP_in_expression292 = new BitSet(
        new long[] {0x0000000000000004L});
    public static final BitSet FOLLOW_expression_in_expression294 = new BitSet(
        new long[] {0x0000000000000008L});
    public static final BitSet FOLLOW_rule_in_expression300 = new BitSet(
        new long[] {0x0000000000000002L});
    public static final BitSet FOLLOW_ANY_in_expression305 = new BitSet(
        new long[] {0x0000000000000002L});
    public static final BitSet FOLLOW_OTHER_in_expression310 = new BitSet(
        new long[] {0x0000000000000002L});
    public static final BitSet FOLLOW_OR_in_condition324 = new BitSet(
        new long[] {0x0000000000000004L});
    public static final BitSet FOLLOW_condition_in_condition326 = new BitSet(
        new long[] {0x0000000000402100L});
    public static final BitSet FOLLOW_condition_in_condition328 = new BitSet(
        new long[] {0x0000000000000008L});
    public static final BitSet FOLLOW_rule_in_condition335 = new BitSet(
        new long[] {0x0000000000000002L});
    public static final BitSet FOLLOW_TRUE_in_condition341 = new BitSet(
        new long[] {0x0000000000000002L});
    public static final BitSet FOLLOW_CALL_in_rule355 = new BitSet(
        new long[] {0x0000000000000004L});
    public static final BitSet FOLLOW_IDENTIFIER_in_rule359 = new BitSet(
        new long[] {0x0000000000000808L});
    public static final BitSet FOLLOW_param_in_rule372 = new BitSet(
        new long[] {0x0000000000000808L});
    public static final BitSet FOLLOW_VAR_in_var_declaration395 = new BitSet(
        new long[] {0x0000000000000004L});
    public static final BitSet FOLLOW_set_in_var_declaration399 = new BitSet(
        new long[] {0x0000000000001000L});
    public static final BitSet FOLLOW_IDENTIFIER_in_var_declaration419 =
        new BitSet(new long[] {0x0000000000000008L});
    public static final BitSet FOLLOW_PARAM_in_param439 = new BitSet(
        new long[] {0x0000000000000004L});
    public static final BitSet FOLLOW_IDENTIFIER_in_param441 = new BitSet(
        new long[] {0x0000000000000008L});
    public static final BitSet FOLLOW_PARAM_in_param451 = new BitSet(
        new long[] {0x0000000000000004L});
    public static final BitSet FOLLOW_OUT_in_param453 = new BitSet(
        new long[] {0x0000000000001000L});
    public static final BitSet FOLLOW_IDENTIFIER_in_param455 = new BitSet(
        new long[] {0x0000000000000008L});
    public static final BitSet FOLLOW_PARAM_in_param465 = new BitSet(
        new long[] {0x0000000000000004L});
    public static final BitSet FOLLOW_DONT_CARE_in_param467 = new BitSet(
        new long[] {0x0000000000000008L});
    public static final BitSet FOLLOW_PARAM_in_param476 = new BitSet(
        new long[] {0x0000000000000004L});
    public static final BitSet FOLLOW_BOOL_TYPE_in_param478 = new BitSet(
        new long[] {0x0000002000400000L});
    public static final BitSet FOLLOW_set_in_param482 = new BitSet(
        new long[] {0x0000000000000008L});
    public static final BitSet FOLLOW_PARAM_in_param495 = new BitSet(
        new long[] {0x0000000000000004L});
    public static final BitSet FOLLOW_STRING_TYPE_in_param497 = new BitSet(
        new long[] {0x0000000000001000L});
    public static final BitSet FOLLOW_IDENTIFIER_in_param501 = new BitSet(
        new long[] {0x0000000000000008L});
    public static final BitSet FOLLOW_PARAM_in_param510 = new BitSet(
        new long[] {0x0000000000000004L});
    public static final BitSet FOLLOW_INT_TYPE_in_param512 = new BitSet(
        new long[] {0x0000000000001000L});
    public static final BitSet FOLLOW_IDENTIFIER_in_param516 = new BitSet(
        new long[] {0x0000000000000008L});
    public static final BitSet FOLLOW_PARAM_in_param525 = new BitSet(
        new long[] {0x0000000000000004L});
    public static final BitSet FOLLOW_REAL_TYPE_in_param527 = new BitSet(
        new long[] {0x0000000000001000L});
    public static final BitSet FOLLOW_IDENTIFIER_in_param531 = new BitSet(
        new long[] {0x0000000000000008L});
