...
public class GCLChecker extends TreeParser {
    ...
    public final GCLChecker.var_declaration_return var_declaration() throws RecognitionException {
        ...
        try {
            ...
            CommonTree _first_1 = null;
            _last = (CommonTree)input.LT(1);
            VAR50=(CommonTree)match(input,VAR,FOLLOW_VAR_in_var_declaration395); 
            ...
            _last = (CommonTree)input.LT(1);
            IDENTIFIER51=(CommonTree)match(input,IDENTIFIER,FOLLOW_IDENTIFIER_in_var_declaration419); 
             
            if ( _first_1==null ) _first_1 = IDENTIFIER51;
             
            		if (!namespace.hasVariable((IDENTIFIER51!=null?IDENTIFIER51.getText():null))) {
            			namespace.addVariable((IDENTIFIER51!=null?IDENTIFIER51.getText():null)); 
            			st.declareSymbol((IDENTIFIER51!=null?IDENTIFIER51.getText():null), t.getText());
            		} else {
            			errors.add("Double declaration of variable '"+(IDENTIFIER51!=null?IDENTIFIER51.getText():null)+"' on line "+(IDENTIFIER51!=null?IDENTIFIER51.getLine():0));
            		}
        ...
        try {
            ...
            switch (alt10) {
                case 1 :
                    ...
                    CommonTree _first_1 = null;
                    _last = (CommonTree)input.LT(1);
                    PARAM52=(CommonTree)match(input,PARAM,FOLLOW_PARAM_in_param439); 


                    if ( _first_0==null ) _first_0 = PARAM52;
                    match(input, Token.DOWN, null); 
                    _last = (CommonTree)input.LT(1);
                    IDENTIFIER53=(CommonTree)match(input,IDENTIFIER,FOLLOW_IDENTIFIER_in_param441); 
                     
                    if ( _first_1==null ) _first_1 = IDENTIFIER53;

                    			if (st.isDeclared((IDENTIFIER53!=null?IDENTIFIER53.getText():null))) {
                    				if (!st.isInitialized((IDENTIFIER53!=null?IDENTIFIER53.getText():null))) {
                    					errors.add("The variable "+(IDENTIFIER53!=null?IDENTIFIER53.getText():null)+" might not have been initialized on line "+(IDENTIFIER53!=null?IDENTIFIER53.getLine():0));
                    				}
                    			} else {
                    				errors.add("No such variable: "+(IDENTIFIER53!=null?IDENTIFIER53.getText():null));
                    			}
                    			if (currentRule != null && currentSig.size() < numParameters) {
                    				errors.add("Rule "+currentRule.getName().toString()+" does not have this many parameters on line "+(IDENTIFIER53!=null?IDENTIFIER53.getLine():0)); 
                    			} else {
                    				if (currentRule != null && currentPar.isOutOnly()) {
                    					errors.add("Parameter number "+(numParameters)+" cannot be an input parameter in rule "+currentRule.getName().toString()+" on line "+(IDENTIFIER53!=null?IDENTIFIER53.getLine():0));
                    				}
                    				if (currentRule != null && !currentPar.getType().toString().equals(st.getType((IDENTIFIER53!=null?IDENTIFIER53.getText():null)))) {
                    					errors.add("Type mismatch between parameter "+numParameters+" of "+currentRule.getName().toString()+" and variable "+(IDENTIFIER53!=null?IDENTIFIER53.getText():null)+" ("+currentPar.getType().toString()+" is not "+st.getType((IDENTIFIER53!=null?IDENTIFIER53.getText():null))+")");
                    				}
                    			}
                ...
                case 2 :
                    ...
                    CommonTree _first_1 = null;
                    _last = (CommonTree)input.LT(1);
                    PARAM54=(CommonTree)match(input,PARAM,FOLLOW_PARAM_in_param451); 


                    if ( _first_0==null ) _first_0 = PARAM54;
                    match(input, Token.DOWN, null); 
                    _last = (CommonTree)input.LT(1);
                    OUT55=(CommonTree)match(input,OUT,FOLLOW_OUT_in_param453); 
                     
                    if ( _first_1==null ) _first_1 = OUT55;
                    _last = (CommonTree)input.LT(1);
                    IDENTIFIER56=(CommonTree)match(input,IDENTIFIER,FOLLOW_IDENTIFIER_in_param455); 
                     
                    if ( _first_1==null ) _first_1 = IDENTIFIER56;

                    			if (st.isDeclared((IDENTIFIER56!=null?IDENTIFIER56.getText():null))) {
                    				if (!st.canInitialize((IDENTIFIER56!=null?IDENTIFIER56.getText():null)) || syntaxInit.contains((IDENTIFIER56!=null?IDENTIFIER56.getText():null))) {
                    					errors.add("Variable already initialized: "+(IDENTIFIER56!=null?IDENTIFIER56.getText():null)+" on line "+(IDENTIFIER56!=null?IDENTIFIER56.getLine():0));
                    				} else {
                    					st.initializeSymbol((IDENTIFIER56!=null?IDENTIFIER56.getText():null));
                    					syntaxInit.add((IDENTIFIER56!=null?IDENTIFIER56.getText():null));
                    				}
                    			} else {
                    				errors.add("No such variable: "+(IDENTIFIER56!=null?IDENTIFIER56.getText():null)+" on line "+(IDENTIFIER56!=null?IDENTIFIER56.getLine():0));
                    			}
                    			if (currentRule != null && currentSig.size() < numParameters) {
                    				errors.add("Rule "+currentRule.getName().toString()+" does not have this many parameters on line "+(IDENTIFIER56!=null?IDENTIFIER56.getLine():0)); 
                    			} else {
                    			...
                    			currentOutputParameters.add((IDENTIFIER56!=null?IDENTIFIER56.getText():null));
                ...
                case 3 :
                    ...
                    CommonTree _first_1 = null;
                    _last = (CommonTree)input.LT(1);
                    PARAM57=(CommonTree)match(input,PARAM,FOLLOW_PARAM_in_param465); 


                    if ( _first_0==null ) _first_0 = PARAM57;
                    match(input, Token.DOWN, null); 
                    _last = (CommonTree)input.LT(1);
                    DONT_CARE58=(CommonTree)match(input,DONT_CARE,FOLLOW_DONT_CARE_in_param467); 
                ...
                case 4 :
                    ...
                    CommonTree _first_1 = null;
                    _last = (CommonTree)input.LT(1);
                    PARAM59=(CommonTree)match(input,PARAM,FOLLOW_PARAM_in_param476); 


                    if ( _first_0==null ) _first_0 = PARAM59;
                    match(input, Token.DOWN, null); 
                    _last = (CommonTree)input.LT(1);
                    BOOL_TYPE60=(CommonTree)match(input,BOOL_TYPE,FOLLOW_BOOL_TYPE_in_param478); 
                     
                    if ( _first_1==null ) _first_1 = BOOL_TYPE60;
                    _last = (CommonTree)input.LT(1);
                ...
                case 5 :
                    ...
                    CommonTree _first_1 = null;
                    _last = (CommonTree)input.LT(1);
                    PARAM61=(CommonTree)match(input,PARAM,FOLLOW_PARAM_in_param495); 


                    if ( _first_0==null ) _first_0 = PARAM61;
                    match(input, Token.DOWN, null); 
                    _last = (CommonTree)input.LT(1);
                    STRING_TYPE62=(CommonTree)match(input,STRING_TYPE,FOLLOW_STRING_TYPE_in_param497); 
                     
                    if ( _first_1==null ) _first_1 = STRING_TYPE62;
                    _last = (CommonTree)input.LT(1);
                    str=(CommonTree)match(input,IDENTIFIER,FOLLOW_IDENTIFIER_in_param501); 
                ...
                case 6 :
                    ...
                    CommonTree _first_1 = null;
                    _last = (CommonTree)input.LT(1);
                    PARAM63=(CommonTree)match(input,PARAM,FOLLOW_PARAM_in_param510); 


                    if ( _first_0==null ) _first_0 = PARAM63;
                    match(input, Token.DOWN, null); 
                    _last = (CommonTree)input.LT(1);
                    INT_TYPE64=(CommonTree)match(input,INT_TYPE,FOLLOW_INT_TYPE_in_param512); 
                     
                    if ( _first_1==null ) _first_1 = INT_TYPE64;
                    _last = (CommonTree)input.LT(1);
                    in=(CommonTree)match(input,IDENTIFIER,FOLLOW_IDENTIFIER_in_param516); 
                ...
                case 7 :
                    ...
                    CommonTree _first_1 = null;
                    _last = (CommonTree)input.LT(1);
                    PARAM65=(CommonTree)match(input,PARAM,FOLLOW_PARAM_in_param525); 


                    if ( _first_0==null ) _first_0 = PARAM65;
                    match(input, Token.DOWN, null); 
                    _last = (CommonTree)input.LT(1);
                    REAL_TYPE66=(CommonTree)match(input,REAL_TYPE,FOLLOW_REAL_TYPE_in_param527); 
                     
                    if ( _first_1==null ) _first_1 = REAL_TYPE66;
                    _last = (CommonTree)input.LT(1);
                    r=(CommonTree)match(input,IDENTIFIER,FOLLOW_IDENTIFIER_in_param531); 
    ...
    public static final BitSet FOLLOW_statement_in_block122 = new BitSet(new long[]{0x000000000FABE708L});
    ...
    public static final BitSet FOLLOW_param_in_rule372 = new BitSet(new long[]{0x0000000000000808L});
    public static final BitSet FOLLOW_VAR_in_var_declaration395 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_set_in_var_declaration399 = new BitSet(new long[]{0x0000000000001000L});
    public static final BitSet FOLLOW_IDENTIFIER_in_var_declaration419 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_PARAM_in_param439 = new BitSet(new long[]{0x0000000000000004L});
    ...
    public static final BitSet FOLLOW_OUT_in_param453 = new BitSet(new long[]{0x0000000000001000L});
    public static final BitSet FOLLOW_IDENTIFIER_in_param455 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_PARAM_in_param465 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_DONT_CARE_in_param467 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_PARAM_in_param476 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_BOOL_TYPE_in_param478 = new BitSet(new long[]{0x0000002000400000L});
    public static final BitSet FOLLOW_set_in_param482 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_PARAM_in_param495 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_STRING_TYPE_in_param497 = new BitSet(new long[]{0x0000000000001000L});
    public static final BitSet FOLLOW_IDENTIFIER_in_param501 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_PARAM_in_param510 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_INT_TYPE_in_param512 = new BitSet(new long[]{0x0000000000001000L});
    public static final BitSet FOLLOW_IDENTIFIER_in_param516 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_PARAM_in_param525 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_REAL_TYPE_in_param527 = new BitSet(new long[]{0x0000000000001000L});
    public static final BitSet FOLLOW_IDENTIFIER_in_param531 = new BitSet(new long[]{0x0000000000000008L});
