 ...
 * 
 */
public abstract class AbstractControlTransition implements ControlTransition {

	private ControlState source;
	private ControlState target;
	
	/**
	 * @param source is the source ControlState of this transition
	 * @param target is the target ControlState of this transition
	 */
	public AbstractControlTransition(ControlState source, ControlState target)
	{
		this.source = source;
		this.target = target;
	}
