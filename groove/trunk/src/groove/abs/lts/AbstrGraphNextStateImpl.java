...
/**
 * Combines an {@link AbstrGraphState} and an {@link AbstrGraphTransition}.
 * The graph transition functionality is implemented by an enclosed
 * {@link AbstrGraphTransition}.
 * @author Iovka Boneva
 * @version $Revision $
 */
public class AbstrGraphNextStateImpl extends AbstrGraphStateImpl implements AbstrGraphNextState {
	 ...
	 * @param event
	 */
	public AbstrGraphNextStateImpl(AbstrGraph graph, AbstrGraphState source, RuleEvent event) {
		super(graph); 
		this.theTrans = new AbstrGraphTransitionImpl(source, event, null);
	}
	
	/** The transition component. */
	private AbstrGraphTransitionImpl theTrans;
	...
	public boolean equals(Object o) {
		...
		// the targets of this.theTrans and other.theTrans cannot be compared with equals, as they are both null
		result = result && this.theTrans.source().equals(other.theTrans.source());
	...
	public Node[] getAddedNodes() {
		return theTrans.getAddedNodes();
	}

	public RuleEvent getEvent() {
		return theTrans.getEvent();
	}

	public RuleMatch getMatch() {
		return theTrans.getMatch();
	}

	public Morphism getMorphism() {
		return theTrans.getMorphism();
	}
	...
	public boolean isEquivalent(AbstrGraphTransition other) {
		...
		return theTrans.isEquivalent(other);
	}	
