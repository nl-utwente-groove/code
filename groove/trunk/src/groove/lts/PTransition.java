...
/**
 * Transition between Büchi states, essentially consisting of a transition in a
 * Büchi automaton and a transition in a GTS.
 * @author Arend Rensink
 * @version $Revision $
 */
public class PTransition extends
        AbstractBinaryEdge<BuchiGraphState,Label,BuchiGraphState> {
    /**
     * Constructs a transition between two Büchi states, storing the underlying
     * graph transition.
     */
    public PTransition(BuchiGraphState source, GraphTransition transition,
     ...
     * <tt>{@link #equalsSource(PTransition)}</tt>.
     */
    @Override
    public boolean equals(Object obj) {
        return obj instanceof PTransition && equalsSource((PTransition) obj)
            && equalsEvent((PTransition) obj);
    }
