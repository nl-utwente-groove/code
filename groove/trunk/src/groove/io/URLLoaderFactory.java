...
public class URLLoaderFactory {
     ...
     */
    public static AspectualViewGps getLoader(URL url, boolean layouted)
        throws MalformedURLException {
        ...
        throw new MalformedURLException("Unrecognized protocol or format: "
            + url.toExternalForm());
    }
     ...
     */
    public static AspectualViewGps getLoader(URL url)
        throws MalformedURLException {
        return getLoader(url, false);
    }

    /** returns a loader given a string that should hold a wellformed url */
    public static AspectualViewGps getLoader(String url)
        throws MalformedURLException {
