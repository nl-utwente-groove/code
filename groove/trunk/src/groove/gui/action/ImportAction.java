...
import groove.io.external.util.ModelToGraph;
...
public class ImportAction extends SimulatorAction {
    ...
    public ImportAction(Simulator simulator) {
        ...
        ModelToGraph.initSimulator(getSimulator());
    }

    @Override
    public void execute() {
        //TODO: Inits are pretty much a hack
        Importer.init(getSimulatorModel(), getGrammarModel());

        Importer.getInstance().doImport(getFrame());
    }
