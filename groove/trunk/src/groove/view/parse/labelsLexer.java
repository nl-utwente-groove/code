// $ANTLR 3.1b1 labels.g 2010-04-23 09:21:52
...
public class labelsLexer extends Lexer {
    ...
    public labelsLexer() {;} 
    public labelsLexer(CharStream input) {
        this(input, new RecognizerSharedState());
    }
    public labelsLexer(CharStream input, RecognizerSharedState state) {
        super(input,state);
    ...
    public final void mT__63() throws RecognitionException {
        try {
            int _type = T__63;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // labels.g:17:7: ( 'forall' )
            // labels.g:17:9: 'forall'
            {
            match("forall"); 
    ...
    public final void mT__64() throws RecognitionException {
        try {
            int _type = T__64;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // labels.g:18:7: ( 'forallx' )
            // labels.g:18:9: 'forallx'
            {
            match("forallx"); 
    ...
    public final void mT__65() throws RecognitionException {
        try {
            int _type = T__65;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // labels.g:19:7: ( 'exists' )
            // labels.g:19:9: 'exists'
            {
            match("exists"); 
    ...
    public final void mT__66() throws RecognitionException {
        try {
            int _type = T__66;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // labels.g:20:7: ( 'nested' )
            // labels.g:20:9: 'nested'
            {
            match("nested"); 
    ...
    public final void mT__73() throws RecognitionException {
        try {
            int _type = T__73;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // labels.g:27:7: ( 'string' )
            // labels.g:27:9: 'string'
            {
            match("string"); 
    ...
    public final void mSQTEXT() throws RecognitionException {
        try {
            int _type = SQTEXT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // labels.g:128:4: ( SQUOTE (~ ( SQUOTE | BSLASH ) | BSLASH ( BSLASH | SQUOTE ) )* SQUOTE )
            // labels.g:128:6: SQUOTE (~ ( SQUOTE | BSLASH ) | BSLASH ( BSLASH | SQUOTE ) )* SQUOTE
            {
            mSQUOTE(); 
            // labels.g:128:13: (~ ( SQUOTE | BSLASH ) | BSLASH ( BSLASH | SQUOTE ) )*
            loop1:
            do {
                int alt1=3;
            	...
            	case 1 :
            	    ...
            	    break;
            	case 2 :
            	    // labels.g:128:33: BSLASH ( BSLASH | SQUOTE )
            	    {
            	    mBSLASH(); 
    ...
    public final void mDQTEXT() throws RecognitionException {
        try {
            int _type = DQTEXT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // labels.g:131:4: ( DQUOTE (~ ( DQUOTE | BSLASH ) | BSLASH ( BSLASH | DQUOTE ) )* DQUOTE )
            // labels.g:131:6: DQUOTE (~ ( DQUOTE | BSLASH ) | BSLASH ( BSLASH | DQUOTE ) )* DQUOTE
            {
            mDQUOTE(); 
            // labels.g:131:13: (~ ( DQUOTE | BSLASH ) | BSLASH ( BSLASH | DQUOTE ) )*
            loop2:
            do {
                int alt2=3;
            	...
            	case 1 :
            	    ...
            	    break;
            	case 2 :
            	    // labels.g:131:33: BSLASH ( BSLASH | DQUOTE )
            	    {
            	    mBSLASH(); 
            	    if ( input.LA(1)=='\"'||input.LA(1)=='\\' ) {
            	        input.consume();
    ...
    public final void mIDENT() throws RecognitionException {
        try {
            int _type = IDENT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // labels.g:186:4: ( LETTER ( IDENTCHAR )* )
            // labels.g:186:6: LETTER ( IDENTCHAR )*
            {
            mLETTER(); 
            // labels.g:186:13: ( IDENTCHAR )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mNUMBER() throws RecognitionException {
        try {
            int _type = NUMBER;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // labels.g:190:4: ( ( DIGIT )+ )
            // labels.g:190:6: ( DIGIT )+
            {
            // labels.g:190:6: ( DIGIT )+
            int cnt4=0;
            loop4:
    ...
    public final void mRNUMBER() throws RecognitionException {
        try {
            int _type = RNUMBER;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // labels.g:194:4: ( ( ( DIGIT )+ ( DOT ( DIGIT )* )? | DOT ( DIGIT )+ ) )
            // labels.g:194:6: ( ( DIGIT )+ ( DOT ( DIGIT )* )? | DOT ( DIGIT )+ )
            {
            // labels.g:194:6: ( ( DIGIT )+ ( DOT ( DIGIT )* )? | DOT ( DIGIT )+ )
            int alt9=2;
            ...
            switch (alt9) {
                case 1 :
                    // labels.g:194:7: ( DIGIT )+ ( DOT ( DIGIT )* )?
                    {
                    // labels.g:194:7: ( DIGIT )+
                    int cnt5=0;
                    loop5:
                    do {
                        int alt5=2;
                    ...
                    switch (alt7) {
                        case 1 :
                            // labels.g:194:15: DOT ( DIGIT )*
                            {
                            mDOT(); 
                            // labels.g:194:19: ( DIGIT )*
                            loop6:
                            do {
                                int alt6=2;
                    ...
                    break;
                case 2 :
                    // labels.g:194:30: DOT ( DIGIT )+
                    {
                    mDOT(); 
                    // labels.g:194:34: ( DIGIT )+
                    int cnt8=0;
                    loop8:
                    do {
                        int alt8=2;
    ...
    public final void mLABEL() throws RecognitionException {
        try {
            int _type = LABEL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // labels.g:198:4: ( ( IDENTCHAR )* )
            // labels.g:198:6: ( IDENTCHAR )*
            {
            // labels.g:198:6: ( IDENTCHAR )*
            loop10:
            do {
    ...
    public final void mIDENTCHAR() throws RecognitionException {
        try {
            // labels.g:202:4: ( LETTER | DIGIT | DOLLAR | UNDER )
            // labels.g:
            {
