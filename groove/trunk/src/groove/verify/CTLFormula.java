...
public class CTLFormula extends CTLStarFormula {
    ...
    protected TemporalFormula createAll(TemporalFormula operand)
        ...
        if (operand instanceof Next) {
            ...
            throw new FormatException(
                "The path quantifier 'All' should be followed by a temporal operation instead of "
                    + operand);
        }
    }
    ...
    protected TemporalFormula createExists(TemporalFormula operand)
        ...
        if (operand instanceof Next) {
            ...
            throw new FormatException(
                "The path quantifier 'Exists' should be followed by a temporal operation instead of "
                    + operand);
        }
    }
     ...
     */
    protected TemporalFormula createExistsNext(TemporalFormula operand)
        throws FormatException {
     ...
     * @throws FormatException if the formula is not formatted correctly
     */
    protected TemporalFormula createExistsUntil(List<TemporalFormula> operands)
        throws FormatException {
     ...
     * @throws FormatException if the formula is not formatted correctly
     */
    protected TemporalFormula createAllNext(TemporalFormula operand)
        throws FormatException {
        if (operand instanceof TemporalOperator) {
            throw new FormatException(
                "Temporal operators should be proceeded by a path quantifier: "
     ...
     * @throws FormatException if the formula is not formatted correctly
     */
    protected TemporalFormula createAllFinally(TemporalFormula operand)
        throws FormatException {
        if (operand instanceof TemporalOperator) {
            throw new FormatException(
                "Temporal operators should be proceeded by a path quantifier: "
     ...
     * @throws FormatException if the formula is not formatted correctly
     */
    protected TemporalFormula createAllGlobally(TemporalFormula operand)
        throws FormatException {
        if (operand instanceof TemporalOperator) {
            throw new FormatException(
                "Temporal operators should be proceeded by a path quantifier: "
     ...
     * @throws FormatException if the formula is not formatted correctly
     */
    protected TemporalFormula createAllUntil(List<TemporalFormula> operands)
        throws FormatException {
        for (TemporalFormula operand : operands) {
            if (operand instanceof TemporalOperator) {
                throw new FormatException(
     ...
     * @throws FormatException if the formula is not formatted correctly
     */
    protected TemporalFormula createExistsFinally(TemporalFormula operand)
        throws FormatException {
        if (operand instanceof TemporalOperator) {
            throw new FormatException(
                "Temporal operators should be proceeded by a path quantifier: "
     ...
     * @throws FormatException if the formula is not formatted correctly
     */
    protected TemporalFormula createExistsGlobally(TemporalFormula operand)
        throws FormatException {
        if (operand instanceof TemporalOperator) {
            throw new FormatException(
                "Temporal operators should be proceeded by a path quantifier: "
