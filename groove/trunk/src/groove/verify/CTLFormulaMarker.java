...
public interface CTLFormulaMarker {
     ...
     * @param modelChecker
     */
    public void mark(Marking marking, TemporalFormula expr, GTS gts, CTLModelChecker modelChecker);
    ...
    /**
     * Mark each state of the given state-space if that state does satisfies
     * the predicate represented by this CTL-expression.
     * 
     * @param marking the current marking.
     * @param expr the CTL-expression in question.
     * @param gts the state space as a graph transition system.
