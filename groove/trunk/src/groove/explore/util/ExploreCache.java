 ...
 * Such a cache is an iterator over rules that will avoid giving rules
 * that have been fully explored.
 * The cache takes into account information on explored and matched 
 * rules for computing the location resulting in applying a given rule.
 * @author 
 *
 */
