...
/* 
 * $Id: DefaultLabel.java,v 1.1.1.1 2007-03-20 10:05:34 kastenberg Exp $
 */
...
public final class DefaultLabel extends AbstractLabel {
    ...
    /**
     * Returns the unique representative of a {@link DefaultLabel} for a 
     * given string. The string is used as-is, and is guaranteed to 
     * equal the text of the resulting label.
     * @param text the text of the label
     * @return an existinr or new label with the given text
     * @see #parseLabel(String)
     */
    ...
    /**
     * Generates a previously non-existent label.
     * The label generated is of the form index+"L",
    ...
    /**
     * Returns the index of a certain label text, if it is in the list.
     * Returns a special value if the text is not in the list.
     * @param text the label text being looked up
     * @return the index of <tt>text</tt>, if it is the list; <tt>Character.MAX_VALUE</tt> otherwise.
     * @require <tt>text != null</tt>
    ...
    /**
     * Modifies the static index map of this class.
     * If the index map is not empty at the time of invocation, an exception is thrown.
     * Intended for serialization only.
     ...
     */
    protected DefaultLabel(String text) {
