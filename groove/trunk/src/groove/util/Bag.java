...
/*
 * $Id: Bag.java,v 1.1.1.1 2007-03-20 10:05:17 kastenberg Exp $
 */
package groove.util;
...
public interface Bag<T> extends Collection<T> {
    ...
    /**
     * Removes the elements from a given collection from this bag.
     * The difference with {@link #removeAll(Collection)} is that this method
     * only removes as many copies as are present in the other collection.
