...
/**
 * This class provides constants that can be used when loading modules.
 * The constants can be used as identifiers for system properties. Those
 * modules can be enabled or disables by setting the value of the system
 * property properly.
 * 
...
public class GrooveModules {
	 ...
	 */
	public static String GROOVE_MODULE_LTL_VERIFICATION = "groove.modules.verification.ltl";
}
