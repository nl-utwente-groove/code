...
final public class ListEntryIterator implements Iterator<ListEntry> {
    ...
    /**
     * Returns the current entry. The result value is the payload of the current
     * {@link ListEntry}.
     */
    public ListEntry next() {
        ListEntry result = this.current;
        this.current = this.current.getNext();
        return result;
    }

    /**
     * Removal cannot be supported for the first element of the list, therefore
     * we disallow it altogether.
