...
import nl.utwente.groove.match.rete.ClosurePathChecker.ClosureInfo;
...
public class RetePathMatch extends AbstractReteMatch {
    ...
    public String toString() {
        return String.format("Path from %s to %s (l= %d) match %s |> %s",
            this.start()
                .toString(),
            this.end()
                .toString(),
            this.pathLength,
            ((AbstractPathChecker) this.getOrigin()).getExpression()
                .toString(),
    ...
    public static class EmptyPathMatch extends RetePathMatch {
        ...
        @Override
        public String toString() {
            return String.format("Empty path matched by %s",
                ((AbstractPathChecker) this.getOrigin()).getExpression()
                    .toString());
        }
    ...
    /** Key for a path match. */
    public static record Key(HostNode start, HostNode end, Valuation valuation) {
        /** Constructs a key for a given path match. */
        public Key(RetePathMatch pm) {
            this(pm.start(), pm.end(), pm.getValuation());
