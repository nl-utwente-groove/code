...
public class GraphProperties extends Properties {
    ...
    public static enum Key implements PropertyKey<Object> {
        ...
        /** Match filter. */
        FILTER("matchFilter", "<body>Boolean method or predicate that filters the matches of the rule. <br>" + "Format: <tt>lang:name</tt> where the optional <tt>lang</tt> is the name of a language (by default Java) and <tt>name</tt> the fully qualified method name.<br>" + "The method may optionally take parameters of type <tt>groove.grammar.host.HostGraph</tt> and <tt>groove.transform.RuleEvent</tt><br/>" + "Supported languages are: <tt>" + Groove.toString(Language.values(), "", "", ", ") + "</tt>", MethodNameParser.instance()),
