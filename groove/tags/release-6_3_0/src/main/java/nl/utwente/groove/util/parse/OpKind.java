...
import static nl.utwente.groove.util.parse.OpKind.Direction.LEFT;
import static nl.utwente.groove.util.parse.OpKind.Direction.NEITHER;
import static nl.utwente.groove.util.parse.OpKind.Direction.RIGHT;
import static nl.utwente.groove.util.parse.OpKind.Placement.INFIX;
import static nl.utwente.groove.util.parse.OpKind.Placement.PREFIX;
