...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph edgemode="directed" edgeids="false" role="graph" id="createEdge-1-0">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <attr name="$version">
        ...
        <edge to="n1" from="n1">
            <attr name="label">
                <string>rem:Creating an existng edge does not change the graph</string>
            </attr>
        </edge>
        <edge to="n3" from="n3">
            <attr name="label">
