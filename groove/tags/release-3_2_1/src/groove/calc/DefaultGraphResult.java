...
/**
 * Default implementation of a {@link GraphResult}, using the
 * {@link DefaultGraphCalculator} for its calculations.
...
// */
// public DefaultGraphResult(DefaultGraphCalculator calculator, GraphState
// state) {
...
// GraphState nextState = (GraphState) record.getApplication(matches.next(),
// state.getGraph()).getTarget();
...
// SystemRecord record = calculator.getGTS().getRecord();
// GraphState nextState = (GraphState)
// record.getApplication(match,state.getGraph()).getTarget();
