 ...
 * {@link BigDecimal}, or other classes/frameworks dedicated to precise
...
public class DefaultRealAlgebra extends OldAlgebra {
    ...
    public String getSymbol(Object value) {
        if (!(value instanceof Double)) {
            throw new IllegalArgumentException(String.format(
                "Value is of class %s rather than Double", value.getClass()));
        }
    ...
    private static abstract class Double2DoubleOperation extends
            DefaultOperation {
        /**
