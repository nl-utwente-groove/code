...
/**
 * Interface for a parser that can translate a string to an aspect value content
 * of a given (generic) type and back.
...
public interface ContentParser<C> {
     ...
     *         formatted according to the rules of this parser.
     */
    C toContent(String value) throws FormatException;

    /**
     * Gives a string description of a given content. This is the inverse
     * operation of {@link #toContent(String)}.
