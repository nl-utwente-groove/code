 ...
 * provide a name and a multi-line description (used in help functionality) and
 * they may specify that they need a parameter. If a command-line option with
...
public interface CommandLineOption {
    ...
    /**
     * Effects this option, with a given parameter (null if the option does not
     * require one).
