...
/**
 * Parser that turns a string into a default label, after testing the string for
 * correct formatting using a callback method that can be overridden by
 * subclasses.
 */
public class NumberLabelParser extends FreeLabelParser {
    ...
    protected String getExceptionText(String text) {
        try {
            ...
            return String.format("String '%s' cannot be parsed as a number",
                text);
        }
    }
