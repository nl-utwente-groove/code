...
public abstract class NodeFactory<N extends Node> {
    ...
    /** 
     * Returns a suitable node with a number not used in a given set of nodes.
     * This calls {@link #createNode(Dispenser)} with a {@link FreeNumberDispenser}.
     * @see #createNode(Dispenser)
     */
    public N createNode(Collection<? extends Node> forbidden) {
        return createNode(new FreeNumberDispenser(forbidden));
    }

    /** 
     * Returns a suitable node with a number outside a given array.
     * This calls {@link #createNode(Dispenser)} with a {@link FreeNumberDispenser}.
     * @see #createNode(Dispenser)
     */
    public N createNode(int forbidden[]) {
        return createNode(new FreeNumberDispenser(forbidden));
    }
