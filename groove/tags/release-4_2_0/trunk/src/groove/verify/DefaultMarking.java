...
/**
 * This class keeps track of the properties satisfied for a particular state. A
 * state will thus be mapped on a set of properties it satisfies.
...
public class DefaultMarking extends HashMap<GraphState,Set<TemporalFormula>>
    ...
    /**
     * Removes the given CTL-expression from the set of propositions fulfilled
     * by the given state.
     * @param state the state which is said not to fulfill the given
     *        CTL-expression
