...
//        public Related(Node pre, Node post) {
//        	super(pre);
//            this.post = post;
//        }
//
...
//            return new Node[] { source, post };
//        }
//
//        public final Node end(int i) {
//            switch (i) {
//                case Pair.SOURCE_INDEX :
//                    return source;
//                case Pair.TARGET_INDEX :
//                    return post;
//                default :
//                    throw new IllegalArgumentException("Pair does not have endpoint number " + i);
//            }
//        }
//
...
//        }
//
//        public Element imageFor(Map map) {
//            Node preImage = (Node) map.get(source);
//            if (preImage != null) {
//                Node postImage = (Node) map.get(post);
//                if (postImage != null) {
//                    return createRelated(preImage, postImage);                    
//                }
//                return null;
//            }
//            return null;
...
//        
//        public int hashCode() {
//            return (source.hashCode() << 1)+post.hashCode();
//        }
//        
