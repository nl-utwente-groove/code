...
public class Valuator {
    ...
    /** Pushes a child valuation onto an existing (nested) valuation. */
    public static Object[] push(Object[] val, Object[] child) {
        assert !isNested(child);
        Object[] result = new Object[child.length + 1];
        System.arraycopy(child, 0, result, 0, child.length);
        result[child.length] = val;
        return result;
    }
     ...
     */
    public static Object[] replace(Object[] val, Object[] child) {
        return isNested(val) ? push(pop(val), child) : child;
    }
     ...
     */
    public static Object[] pop(Object[] val) {
        return isNested(val) ? (Object[]) val[val.length - 1] : null;
    }
    ...
    static public int hashCode(Object[] val, Map<? extends Element,?> modifier) {
        ...
        for (int i = 0; i < count; i++) {
            Object repr = val[i] == null ? null : modifier.get(val[i]);
