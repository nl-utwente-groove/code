...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph edgemode="directed" edgeids="false" role="graph" id="append-2-list-5">
        <node id="n92">
            <attr name="layout">
                <string>69 152 29 18</string>
            </attr>
        </node>
        <node id="n101">
            <attr name="layout">
                <string>432 223 15 18</string>
            </attr>
        </node>
        <node id="n91">
            <attr name="layout">
                <string>280 224 15 18</string>
            </attr>
        </node>
        <node id="n99">
            <attr name="layout">
                <string>478 157 18 18</string>
            </attr>
        </node>
        <node id="n102">
            <attr name="layout">
                <string>174 248 15 18</string>
            </attr>
        </node>
        <node id="n90">
            <attr name="layout">
                <string>237 150 18 18</string>
            </attr>
        </node>
        <node id="n93">
            <attr name="layout">
                <string>200 224 15 18</string>
            </attr>
        </node>
        <node id="n96">
            <attr name="layout">
                <string>58 56 51 34</string>
            </attr>
        </node>
        <node id="n103">
            <attr name="layout">
                <string>162 152 18 18</string>
            </attr>
        </node>
        <node id="n98">
            <attr name="layout">
                <string>510 222 15 18</string>
            </attr>
        </node>
        <node id="n100">
            <attr name="layout">
                <string>168 61 15 18</string>
            </attr>
        </node>
        <node id="n94">
            <attr name="layout">
                <string>57 241 51 34</string>
            </attr>
        </node>
        <node id="n95">
            <attr name="layout">
                <string>399 155 18 18</string>
            </attr>
        </node>
        <node id="n104">
            <attr name="layout">
                <string>358 220 15 18</string>
            </attr>
        </node>
        <node id="n97">
            <attr name="layout">
                <string>316 153 18 18</string>
            </attr>
        </node>
