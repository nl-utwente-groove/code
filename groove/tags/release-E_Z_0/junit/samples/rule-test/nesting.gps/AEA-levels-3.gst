...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph id="AEA-levels-3" role="graph" edgeids="false" edgemode="directed">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <node id="n138732"/>
        ...
        <edge from="n138733" to="n138730">
            <attr name="label">
                <string>d</string>
            </attr>
        </edge>
        <edge from="n138733" to="n138733">
            <attr name="label">
                <string>B</string>
            </attr>
        </edge>
