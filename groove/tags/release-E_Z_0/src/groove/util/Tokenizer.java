...
/**
 * Tokenizer that only returns tokens with an even number of quotes. The method
 * <tt>countTokens()</tt> is invalidated. Can handle dots inside quotes, even
 * delimiter is a dot.
...
public class Tokenizer extends StringTokenizer {
    ...
    public String nextToken() {
        ...
        do {
            ...
            if (this.delims.compareTo(".") == 0
                && this.str.charAt(toIndex) == '"') {
                quoted = true;
            }
