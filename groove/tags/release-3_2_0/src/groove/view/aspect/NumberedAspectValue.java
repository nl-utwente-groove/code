...
public class NumberedAspectValue extends ContentAspectValue<Integer> {
     ...
     *         aspect value
     */
    public NumberedAspectValue(Aspect aspect, String name)
    ...
    public ContentAspectValue<Integer> newValue(String value)
        throws FormatException {
        return new NumberedAspectValue(this, this.parser.toContent(value));
    }
        ...
        public Integer toContent(String value) throws FormatException {
            try {
                ...
                throw new FormatException(
                    "Value '%s' cannot be parsed as number", value);
            }
        }
