...
public class TestingPatternFamily extends junit.framework.TestCase {
    ...
    public void setUp() {
        ...
        // init withSym
        this.withSym = new DefaultGraph();
        this.withSym.addEdge(DefaultEdge.createEdge(this.nodes[0], this.a_lab,
            this.nodes[1]));
        this.withSym.addEdge(DefaultEdge.createEdge(this.nodes[0], this.a_lab,
            this.nodes[2]));
        this.withSym.addEdge(DefaultEdge.createEdge(this.nodes[1], this.b_lab,
            this.nodes[3]));
        this.withSym.addEdge(DefaultEdge.createEdge(this.nodes[2], this.b_lab,
            this.nodes[3]));
        this.withSym.addEdge(DefaultEdge.createEdge(this.nodes[4], this.b_lab,
            this.nodes[3]));
        this.withSym.addEdge(DefaultEdge.createEdge(this.nodes[5], this.c_lab,
            this.nodes[4]));
        this.withSym.addEdge(DefaultEdge.createEdge(this.nodes[6], this.c_lab,
            this.nodes[4]));
        this.withSym.addEdge(DefaultEdge.createEdge(this.nodes[5], this.d_lab,
            this.nodes[6]));
        this.withSym.addEdge(DefaultEdge.createEdge(this.nodes[6], this.d_lab,
            this.nodes[5]));
        this.withSym.addEdge(DefaultEdge.createEdge(this.nodes[8], this.e_lab,
            this.nodes[7]));
        this.withSym.addEdge(DefaultEdge.createEdge(this.nodes[9], this.e_lab,
            this.nodes[7]));
        this.withSym.addEdge(DefaultEdge.createEdge(this.nodes[8], this.e_lab,
            this.nodes[9]));
    ...
    public void testGraphPattern() throws ExceptionIncompatibleWithMaxIncidence {
        ...
        GraphPattern p0 = pf.computeAddPattern(this.withSym, this.nodes[0]);
        GraphPattern p3 = pf.computeAddPattern(this.withSym, this.nodes[3]);
        GraphPattern p4 = pf.computeAddPattern(this.withSym, this.nodes[4]);
        GraphPattern p7 = pf.computeAddPattern(this.withSym, this.nodes[7]);

        // local nodes, for the small graphs.
        Node[] nl = new Node[4];
        for (int i = 0; i < nl.length; i++) {
            nl[i] = DefaultNode.createNode();
        }

        // The graphs. The first number within parenthesis is the central node
        // idx
        // The second number within parenthesis is the expected number of
        // morphisms
