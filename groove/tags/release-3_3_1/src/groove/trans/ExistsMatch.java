...
/**
 * Match of an existential condition. The match wraps an element map, from the
 * object that has been matched to the elements of the host graph in which it
 * has been matched.
...
public class ExistsMatch extends CompositeMatch {
    ...
    public boolean equals(Object obj) {
        return obj instanceof ExistsMatch && super.equals(obj);
    }
    ...
    public String toString() {
        return String.format("Nodes %s, edges %s", getElementMap().nodeMap(),
