...
public class Version {
    ...
    public static final String BUILD = "20111005"; // eventually automatically set
    // during Ant compilation!

    /** Release date of this version (date format dd.MM.yyyy). */
    public static final String DATE = "05.10.2011"; // eventually automatically
    // set during Ant
    // compilation!
     ...
     */
    public static final String NUMBER = "4.4.3+";
