...
public interface Equator<T> {
    ...
    /**
     * Method that determines if two objects, presumably with the same hash codes, are
     * actually to be considered equal.
     * Where applicable, <code>oldKey</code> is a known value, e.g., already in some set,
     * and <code>newKey</code> is a new object to be compared with the old one.
     * The method should only be called if <code>getCode(newKey) == getCode(oldKey)</code>.
     * @param newKey the first object to be compared
     * @param oldKey the second object to be compared
     * @return <code>true</code> if <code>newKey</code> is considered equal to <code>oldKey</code>.
     */
