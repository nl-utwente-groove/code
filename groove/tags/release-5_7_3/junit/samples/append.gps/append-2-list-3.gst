...
<gxl xmlns="http://www.gupro.de/GXL/gxl-1.0.dtd">
    <graph edgemode="directed" edgeids="false" role="graph" id="append-2-list-3">
        <attr name="$version">
            <string>curly</string>
        </attr>
        <attr name="$version">
        ...
        <node id="n96">
            <attr name="layout">
                <string>58 56 51 36</string>
            </attr>
        </node>
        <node id="n93">
            <attr name="layout">
                <string>200 224 17 21</string>
            </attr>
        </node>
        <node id="n94">
            <attr name="layout">
                <string>57 241 51 36</string>
            </attr>
        </node>
        <node id="n92">
            <attr name="layout">
                <string>69 152 33 21</string>
            </attr>
        </node>
        <node id="n90">
            <attr name="layout">
                <string>237 150 17 17</string>
            </attr>
        </node>
        <node id="n100">
            <attr name="layout">
                <string>168 61 17 21</string>
            </attr>
        </node>
        <node id="n103">
            <attr name="layout">
                <string>162 152 17 17</string>
            </attr>
        </node>
        <node id="n91">
            <attr name="layout">
                <string>280 224 17 21</string>
            </attr>
        </node>
        <node id="n102">
            <attr name="layout">
                <string>174 248 17 21</string>
            </attr>
        </node>
        <node id="n97">
            <attr name="layout">
                <string>316 153 17 17</string>
            </attr>
        </node>
        <node id="n104">
            <attr name="layout">
                <string>358 220 17 21</string>
            </attr>
        </node>
