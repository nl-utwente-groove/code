 ...
 * @deprecated use {@link CTLModelChecker} instead
 */
@Deprecated
public class DeprecatedCTLModelChecker extends CommandLineTool {
        ...
        if (splitPoint < 0) {
            ...
            List<String> genArgs =
                new LinkedList<String>(argList.subList(splitPoint + 1,
                    argList.size()));
            DeprecatedCTLModelChecker verifier =
                new DeprecatedCTLModelChecker(checkerArgs, genArgs);
            try {
                verifier.start();
            } catch (Exception e) {
                e.printStackTrace();
     ...
     */
    public DeprecatedCTLModelChecker(List<String> checkerArgs, List<String> genArgs) {
