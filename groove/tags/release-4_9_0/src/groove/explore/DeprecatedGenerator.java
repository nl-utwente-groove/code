 ...
 * @deprecated use Geneator instead
 */
@Deprecated
public class DeprecatedGenerator extends CommandLineTool {
    /**
    ...
    static public GTS generate(String[] args) {
        return new DeprecatedGenerator(args).start();
    }
     ...
     * option classes.
     */
    public DeprecatedGenerator(String... args) {
        super(false, args);
