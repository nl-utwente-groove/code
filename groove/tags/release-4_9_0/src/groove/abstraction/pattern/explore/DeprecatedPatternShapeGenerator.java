...
import groove.abstraction.neigh.explore.DeprecatedShapeGenerator;
 ...
 * See also {@link DeprecatedShapeGenerator}.
 * @deprecated Use {@link PatternShapeGenerator} instead
 * @author Eduardo Zambon
 */
@Deprecated
public final class DeprecatedPatternShapeGenerator extends
        DeprecatedPatternGraphGenerator {
     ...
     * option classes.
     */
    public DeprecatedPatternShapeGenerator(String... args) {
        super(args);
    ...
    public static void main(String[] args) {
        new DeprecatedPatternShapeGenerator(args).start();
    }
