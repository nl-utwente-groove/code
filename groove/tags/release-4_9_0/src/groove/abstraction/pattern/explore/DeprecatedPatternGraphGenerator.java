 ...
 * @deprecated Use {@link PatternGraphGenerator} instead
 * @author Eduardo Zambon
 */
@Deprecated
public class DeprecatedPatternGraphGenerator extends CommandLineTool {
     ...
     * option classes.
     */
    public DeprecatedPatternGraphGenerator(String... args) {
        super(args);
    }
    ...
    public static void main(String[] args) {
        new DeprecatedPatternGraphGenerator(args).start();
    }
