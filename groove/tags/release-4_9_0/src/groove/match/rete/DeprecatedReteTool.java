 ...
 * 
 * @author Arash Jalali
 * @deprecated use {@link ReteTool} instead
 */
@Deprecated
public class DeprecatedReteTool extends CommandLineTool {
     ...
     */
    public DeprecatedReteTool(String... args) {
        super(args);
    ...
    public static void main(String[] args) {
        new DeprecatedReteTool(args).start();
    }
